...
| IB-D-07 | **Device TTL без cron** | Истёкший token → 401, но `is_active` остаётся true; нет авто-ротации/алертов. DoS устройства, не утечка данных. | low (ops) | Job + политика ротации + UX (см. IB-P-02) |
