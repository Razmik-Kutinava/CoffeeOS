# Архив CHANGELOG — 2026-08

> Перенесено из `docs/operations/journal/CHANGELOG.md` (ctx-trim 2026-09-01).
...
- sms/messenger/flash_call clients: не вызываются из app/config — `# DEAD CODE`
- OTP suite 73/0 green
