...
## 2026-09-18 вЂ” docs: pin TASK_93-G SPEC (todo-block-G canon)

- РљР°РЅРѕРЅ: `todo-block-G.md` + `GATES-block-G.md` + `RLS_PG_INVENTORY.md`
- R1вЂ“R6 В· **R3-B** В· `app.shop_city_lookup` В· Next: `/sbr` RED

## 2026-09-18 вЂ” docs: SPEC #93 TASK_93-G Tenant GUC / RLS / schema

- `todo-block-G.md` + `RLS_PG_INVENTORY.md`: R1 txn В· R2 staff В· **R3-B** В· R5 city GUC В· R6 raise except test
- РќРµ Р»РѕРјР°С‚СЊ В· РџСЂРѕРІРµСЂРєР° В· Next: `/sbr` RED
