...
## 2026-09-18 — feat: TASK_93-D history per_page default 20 [GREEN]

- `OrdersController#history`: blank/0/missing → 20; max 50; T-D1a–d · T-D3a/b PASS
- RED `faca7e3c` · GREEN `9d2b98a8` · зеркало `todo-block-D.md`
- Next: `/regress` (orders + mvp_flow)

## 2026-09-18 — docs: pin TASK_93-G SPEC (todo-block-G vs races)

- Канон блока: 	odo-block-G.md + GATES-block-G.md + RLS_PG_INVENTORY.md (session todo/GATES гоняют параллельные блоки)
- R1–R6 · **R3-B** · pp.shop_city_lookup · Next: /sbr RED
