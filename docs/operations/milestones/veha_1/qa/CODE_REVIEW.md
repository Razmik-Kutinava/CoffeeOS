...
**Коммит:** всегда после шага (`coffeeos-commit-ops.mdc`). **Push / деплой:** только по явной просьбе владельца.
...
1. Коммит + ops после ревью → push / деплой Fly только по просьбе владельца.
2. H.3 живое демо.
