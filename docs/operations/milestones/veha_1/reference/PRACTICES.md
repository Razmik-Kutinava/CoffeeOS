...
Блок **G** — **закрыт**. **H.2** — **закрыт** (2026-05-25). **Git + Fly** — push develop, fix npm v1.53 (`4a25187`). **Веха 1 в ops не закрыта** (H.3, § I — `[ ]`). **Веха 2** — активная разработка параллельно (`docs/operations/session/HANDOFF.md`).
