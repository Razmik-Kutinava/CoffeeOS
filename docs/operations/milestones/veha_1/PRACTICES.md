...
Блок **G** — **закрыт**. Блок **H.2** (прогон QA агентом) — **закрыт** (2026-05-25). Остаётся **H.3** живое демо (владелец).
...
**Не закрыто агентом:** § H.3 живое демо; § I ops (формальное закрытие вехи); коммит/деплой Fly (ждёт апрува).
...
**Коммит/деплой:** не делали — ждём апрува.
