...
- [ ] ⭐ Живое демо заказчиком — **в процессе** (2026-05-30: только § 1, [`DEMO_FEEDBACK.md`](DEMO_FEEDBACK.md) + PDF в `artifacts/`)
...
- [ ] ⭐ Демо: бариста → заказ → склад; shop → заказ; УК → точка/каталог (см. LIVE_DEMO § 10) — **4 истории не пройдены**
...
- [ ] `docs/operations/session/SESSION_STATE.md` — статус «Веха 1 закрыта» или явный список хвостов
- [ ] `docs/operations/journal/CHANGELOG.md` — запись о закрытии В1
