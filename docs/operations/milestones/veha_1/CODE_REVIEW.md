...
**Цель:** качество диффа и риски до H.3 (живое демо). Поведение уже закрыто H.2 (`docs/operations/milestones/veha_1/QA_ACCEPTANCE_RUN.md`).
...
| CR-3 | OK | `app/services/shop/order_creator.rb` | Shop без `cash_shift_id` | Комментарий + `docs/operations/milestones/veha_1/ORDER_ENTRY_AUDIT.md` |
...
| CR-10 | OK | Гибрид смены | `block_g_cash_shift_test` + `docs/operations/milestones/veha_1/ORDER_ENTRY_AUDIT.md` | Покрыто |
