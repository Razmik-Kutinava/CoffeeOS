...
| V2-BACKLOG-PREP-MULTI | Один заготовочный цех на **несколько** точек продаж | **done 2026-08-31** | Links + UI + org guard + wiring (queue/stop-list/reports/incidents) + platform `/admin/tenants/:id` |
