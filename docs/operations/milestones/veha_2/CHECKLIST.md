...
См. [`DEMO_FEEDBACK.md`](DEMO_FEEDBACK.md) — **открыт** (2026-06-02: PDF §1–3, 5 строк; 2 фикса в коде, 3 open). В1 §1 — [`../veha_1/DEMO_FEEDBACK.md`](../veha_1/DEMO_FEEDBACK.md). §I не закрываем.
...
**Прогон 10 (блоки 0–14):** [`QA_ACCEPTANCE_RUN.md`](QA_ACCEPTANCE_RUN.md) § «Прогон 10 — блоки 0–14». Прогона 11 нет. Вход агента: [`SESSION_STATE.md`](../../SESSION_STATE.md).
