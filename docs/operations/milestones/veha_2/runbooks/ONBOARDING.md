...
**Fly demo (режим B):** `https://coffeeos.fly.dev/shop?tenant_id=…` — slug в БД тот же, поддомен после своего домена. См. [`../../dev/SHOP_URL_MODES.md`](../../dev/SHOP_URL_MODES.md), [`INFRA_URLS.md`](INFRA_URLS.md).
