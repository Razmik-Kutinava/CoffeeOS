...
**Два режима (Fly demo vs прод):** [`../../dev/SHOP_URL_MODES.md`](../../dev/SHOP_URL_MODES.md) — **источник правды**.
...
Инструкция стенда: [`../../demo/FLY_DEMO_STAND.md`](../../demo/FLY_DEMO_STAND.md).

---

## Локальная разработка

См. [`../../dev/SHOP_URL_MODES.md`](../../dev/SHOP_URL_MODES.md) § «Локальная разработка».
