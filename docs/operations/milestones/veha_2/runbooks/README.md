# runbooks — инструкции и процедуры

| Файл | Назначение |
|------|------------|
| [ONBOARDING.md](ONBOARDING.md) | Модель: org → точки → модули → входы |
...
| [ORDER_ENTRY_AUDIT.md](ORDER_ENTRY_AUDIT.md) | Каналы заказа + смена |
| [OFFLINE_SYNC.md](OFFLINE_SYNC.md) | Offline POS (этап позже) |
| [FLUTTER_API.md](FLUTTER_API.md) | API для Flutter-клиента |
| [PROG10_TENANTS.md](PROG10_TENANTS.md) | Prog10: тенанты и smoke |
