...
**Блок ONBOARDING_CHECKLIST §1–7:** `[x]` по коду; **приёмка §71–73 не закрыта** — ждём заказчика + доработку CON-03/04.
...
4. **Следующий прогон MCP:** TEN-02..04 на чистой org, CON-01 (цена), ACC-01 epic, SHP-08 simulate.
