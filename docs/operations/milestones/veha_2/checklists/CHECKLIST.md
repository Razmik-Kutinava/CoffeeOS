...
- [x] **B1.13** Новая навигация витрины — **rev2 S1-R1/S2a/S2b/S3-rev2** `[x]` апрув телефон 2026-07-01 · MCP 22/22 · **S4** `[ ]` · [`B1_13`](../requirements/customer_tasks/B1_13_shop_nav_profile_header.md)
