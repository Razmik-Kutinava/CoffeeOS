...
- [x] **B1.13** Новая навигация витрины — **rev2** `[x]` · **CR-BOTTOM-NAV** answers **`[x]` 2026-07-07** · O1–O3 open · **S4** `[ ]` · [`B1_13`](../requirements/customer_tasks/B1_13_shop_nav_profile_header.md) **стр. ~69**
