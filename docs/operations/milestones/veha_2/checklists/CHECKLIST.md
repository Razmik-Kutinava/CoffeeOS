...
- [x] **B1.13** Новая навигация витрины — **rev2** `[x]` (апрув 2026-07-01) · **S1 апрув `[x]` 2026-07-05** · **S4** `[ ]` · **CR-BOTTOM-NAV** `[ ]` open · [`B1_13`](../requirements/customer_tasks/B1_13_shop_nav_profile_header.md)
