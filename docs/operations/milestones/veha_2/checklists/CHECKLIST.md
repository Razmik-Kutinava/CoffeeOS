...
- [ ] **B1.13** Новая навигация витрины — **rev1** S1–S3 код `[x]` · **rev2** docs `[x]` 2026-06-25 (S1-R1, S2a, S2b, S3-rev2) · скрины rev2 `[ ]` · код rev2 `[ ]` · S4 `[ ]` · [`B1_13`](../requirements/customer_tasks/B1_13_shop_nav_profile_header.md)
