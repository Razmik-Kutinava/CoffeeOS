...
- [ ] **B1.13** Новая навигация витрины — **эпик S1–S4** — **S1 MCP** `[x]` · **S2 MCP 9/9** `[x]` · **S3 код** `[x]` 2026-06-25 · MCP S3 после deploy · S4 `[ ]` · [`B1_13`](../requirements/customer_tasks/B1_13_shop_nav_profile_header.md)
