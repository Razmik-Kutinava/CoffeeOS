...
- [x] **shift_manager** (`shift-a`) → `/manager` *(2026-05-28: AUTH-06 PASS)*
- [x] **franchise_manager** (`franchise@`) → `/manager` *(2026-05-28: AUTH-02 PASS)*
- [x] **prep_kitchen_worker** (`pk-worker`) → `/prep_kitchen` *(2026-05-28: AUTH-08 PASS)*
