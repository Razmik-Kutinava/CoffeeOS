...
**Сейчас (2026-06-04):** §E **открыт**. §2.3–2.4 витрина оплата — **done *(MCP Fly)***. **Следующий:** §2.5 slow-net; подсказки онбординга; УК/franchise staff.
...
| 2026-06-04 | заказчик PDF §2.4 | shop оплата | Двойной «Оплатить» — один заказ | **done** *(MCP)* | [`mcp_section_2_4_fly_2026-06-04.json`](artifacts/demo-feedback/mcp_section_2_4_fly_2026-06-04.json); код `11ab05f` |
...
| Подсчёт дублей заказов в БД на Fly | **не гоняли** |

**Дальше:** §2.5 slow-net; **обязательно** подсказки онбординга; **open** УК/franchise staff.
...
| Подсчёт 2 заказов в БД при double-click | Не проверяли; UI PASS |
