...
- [x] G2: узкий регресс зоны shop orders API (§8)
  ...
  EXPECT: 0 failures, 0 errors
  CWD: C:/Tools/workarea/CoffeeOS
  EVIDENCE: automatic-evidence=v1; definition-sha256=adaed0855350087f846fdec25730c319a103added965800ba059dc54281dcbf2; exit=0; EXPECT=matched; output-sha256=7b526aeaa804a369ad6d6a436935db7335698a2d2f9836b021960b48fa66561b; output-bytes=1636; shell=C:\Windows\system32\cmd.exe; cwd=C:\Tools\workarea\CoffeeOS; path=54c8ad8163c5/77 entries

- [x] G3: D2 клиент — нет `per_page=1` в shop ЛК/orders; default 20 согласован
  EVIDENCE: 2026-09-18 manual — PersonalAccount.svelte `api("/orders/history")` без per_page; Orders.svelte `today=1` без per_page; shopAccountOrders.js `perPage || 20`; grep frontend: нет `per_page=1`
...
ABANDON: G4 Fly MCP Point A is TASK_93-L DoD, not block D; Local G1–G3 close D; Fly reopen in L

<!--
CoffeeOS TASK_93-D:
- 2026-09-18 /regress: G1/G2 met; G3 manual met; G4 abandoned
- Next: /review
-->
