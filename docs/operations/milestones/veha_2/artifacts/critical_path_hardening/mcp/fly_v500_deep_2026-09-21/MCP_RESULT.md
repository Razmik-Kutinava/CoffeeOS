...
| B | B_phone_verify_6digit | FAIL | http=401 |
| B | B_order_without_email_block | PASS | phone_verified must not 422 on email alone · http=401 |
| D | D_history_default_page | FAIL | PASS if 200; length≥2 needs ≥2 orders on guest — soft · http=401 |
