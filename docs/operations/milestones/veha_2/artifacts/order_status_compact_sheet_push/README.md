...
## Скрины заказчика (ревизия 2026-08-05 + доп. 06 2026-08-06)
...
| `screenshots/06_expanded_sheet_status_plus_cart.png` | «если заказ еще» (обрыв) · стикер **`expanded`** · статус *внутри* expanded-шторки над позициями корзины + оплата; мета «…название позиции (только продукта)» |

Предыдущие скрины (2026-07-31) **заменены** файлами 01–05; **06** добавлен 2026-08-06 (забытый заказчиком в списке приёмки).

## QA заказчика 2026-09-06 (reopen)

| Файл | Зачем |
|---|---|
| `screenshots/qa_2026-09-06/01_bug_sheet_paid_with_line_items_and_x.png` | Баг: состав + X в статусной шторке |
| `screenshots/qa_2026-09-06/02_bug_sheet_cancel_hint_no_1_3_days.png` | Баг: hint отмены без «1–3 дня» |
| `screenshots/qa_2026-09-06/03_…` … `07_…` | Референсы home/product/multi (запас к канону 01–06) |
