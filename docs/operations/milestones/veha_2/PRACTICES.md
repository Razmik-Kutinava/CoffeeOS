...
Техдолг В1 полный список — [`../veha_1/PRACTICES.md`](../veha_1/PRACTICES.md) (не копировать сюда целиком).
...
| Пропуск | Обнаружен | Статус |
|---------|-----------|--------|
| AUTH-06: `shift_manager` login не проверялся в прогонах MCP 1–4 | 2026-05-28 | Открыт — закрыть в прогоне 5 |
