...
| **B1.12** | **Рекуррент + 1 клик** (Т-Банк nonPCI, R1–R3 **rev2**) | код R1–R3 **`[x]`** · Q-R2 **`[x]`** · **приёмка: карта не сохраняется** · апрув `[ ]` | [B1_12_recurrent_payments.md](B1_12_recurrent_payments.md) |
...
| **Checkout payment** | **Выбор оплаты / прикрепление карты** — peek / expanded / expanded+ | **этап 0** `[x]` 2026-07-10 · код `[ ]` (clean slate) | [Выбор способа оплаты и прикрепление банковской карты на экране оформления заказа.md](Выбор%20способа%20оплаты%20и%20прикрепление%20банковской%20карты%20на%20экране%20оформления%20заказа.md) |
...
**Порядок работ:** **B1.12** A1 · **Checkout payment** (после `go`) · **B1.13 S4** · **B1.14-4** · **B2.2** · **B1.4**.
