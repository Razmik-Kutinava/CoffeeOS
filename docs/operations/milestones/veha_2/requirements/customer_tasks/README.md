...
|----|--------|--------|------|
| **B2.1** | **B2-S1:** звук нового заказа на табло | **REGISTERED** · апрув на код `[ ]` | [B2_1_barista_order_board.md](B2_1_barista_order_board.md) § B2-S1 |
...
**Порядок работ (2026-06):** **B2-S1** (апрув → код) · B1.9/B1.7 апрув `[ ]` · B2.2.
