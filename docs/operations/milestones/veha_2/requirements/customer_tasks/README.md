...
| **B1.4** | **PWA витрины** (install, offline) | **ТЗ** 2026-06-11 · реализация `[ ]` | [B1_4_pwa_shop.md](B1_4_pwa_shop.md) |

**Порядок работ (2026-06):** B1.1 закрыта · B2.1 OPS_PASS → **B1.4 PWA** (текущий фокус) · B2.2.
