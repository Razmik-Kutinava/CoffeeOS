...
| B2.2 | Объединить «Меню» + «Создать» | заготовка · след. заход | [B2_2_barista_menu_create_merge.md](B2_2_barista_menu_create_merge.md) |

**Порядок работ (2026-06):** B1.7 прогон заказчика → B1.1 закрыта → **B2.1 табло** → B2.2.
