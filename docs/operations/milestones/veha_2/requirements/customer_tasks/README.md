...
|----|--------|--------|------|
| **B1.7** | **BR-5 регрессия:** второй товар в корзину | **CLOSED OPS** · апрув `[ ]` | [B1_7_checkout_order_screen.md](B1_7_checkout_order_screen.md) |
...
**Порядок работ (2026-06):** второй баг заказчика · B1.9 OPS PASS · апрув B1.7/B1.9 `[ ]` · B1.10 закрыта · B2.2.
