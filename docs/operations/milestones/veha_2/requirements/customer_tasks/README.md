...
| **Phone OTP SMS/Flash Call** | Вход и регистрация по телефону (SMS / Flash Call) + антиспам | **GREEN `[x]`** 2026-07-24 · redeploy/MCP `[ ]` | [Вход и регистрация по номеру телефона SMS Flash Call.md](Вход%20и%20регистрация%20по%20номеру%20телефона%20SMS%20Flash%20Call.md) |
