...
| **Profile Email↔Phone merge** | Связка профилей Email↔Phone + UI управления контактами в PWA | **интейк + SPEC `[x]`** 2026-07-27 · RED `[ ]` | [Связка профилей Email Phone и управление данными пользователя в PWA.md](Связка%20профилей%20Email%20Phone%20и%20управление%20данными%20пользователя%20в%20PWA.md) |
