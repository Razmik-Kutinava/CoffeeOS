...
| **B1.14** | **Адрес точки + выбор точки** в шапке витрины (заказчик «задача 2») | **ТЗ этап 0** `[x]` 2026-06-23 · код `[ ]` · апрув + `go` `[ ]` | [B1_14_shop_tenant_address_header.md](B1_14_shop_tenant_address_header.md) |
...
**Порядок работ (2026-06):** **B1.11** апрув · **B1.12** апрув эпика · **B1.13-S1** апрув · **B1.14** апрув + `go` · **B1.13-S2** · **B2.2** · **B1.4** `[ ]`.
