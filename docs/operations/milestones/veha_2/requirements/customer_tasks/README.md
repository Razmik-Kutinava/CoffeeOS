...
| **Repeat order invalid token payment sheet** | Повторный заказ при невалидном токене: CTA «Добавить карту», BottomSheet «Способ оплаты» | **интейк `[x]`** 2026-07-27 · SPEC `[ ]` ждёт go | [Главный экран — повторный заказ (невалидный токен) BottomSheet выбора способа оплаты.md](Главный%20экран%20—%20повторный%20заказ%20(невалидный%20токен)%20BottomSheet%20выбора%20способа%20оплаты.md) |
