...
| **Bottom sheet expanded grid** | Expanded до 1-го ряда каталога + **сетка товаров 4 в ряд** со скроллом | **RESTART** 2026-07-21 · код откачен · уточнение: сетка = каталог, не шторка | [Bottom Sheet expanded mode и внутренняя сетка 4 в ряд.md](Bottom%20Sheet%20expanded%20mode%20и%20внутренняя%20сетка%204%20в%20ряд.md) |
