...
| **Hidden mode cards** | Режим **hidden**: crop превью товаров (эталон vs «как сейчас») | **SBR SPEC `[x]`** · RED `[ ]` · код `[ ]` · апрув `[ ]` | [Исправление режима отображения Hidden для карточек товаров.md](Исправление%20режима%20отображения%20Hidden%20для%20карточек%20товаров.md) |
