...
- [ ] **Given:** Пользователь нажал «Новая карта» на экране 1000008925.png, открылась форма 1000008924.png.
- [ ] **When:** Пользователь вводит:
...
- [ ] **Then:** Кнопка «Оплатить» активна. В стейте формы установлен флаг `save_card: true`. В DevTools → Network открытый PAN/CVV отсутствуют.
