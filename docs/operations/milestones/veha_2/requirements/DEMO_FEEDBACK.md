...
|------|----------|------------------|------|--------|-------------|
| 2026-07-23 | заказчик cart sheet | свайп шторки | Hit-area: реагировать на весь прямоугольник полосы (не только крючок), чувствительнее | **in_progress** | [ТЗ](customer_tasks/Чувствительность%20свайпа%20шторки%20hit%20area%20прямоугольник.md) |
