...
**Сейчас (2026-07-06):** **B1.13-CR-BOTTOM-NAV** — open (конфликт с каноном S1-R1) · ждём ответы заказчика. **B1.12** — фикс карты Fly v328 · ждёт живую оплату (A1). **Batch апрув 2026-07-05:** B1.4 · B2-S1 · B1.11 · B1.14-client · B1.13-S1 — [`customer_verified_batch_2026-07-05.json`](artifacts/demo-feedback/customer_verified_batch_2026-07-05.json).
