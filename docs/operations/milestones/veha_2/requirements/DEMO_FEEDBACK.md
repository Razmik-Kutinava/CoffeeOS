...
|------|----------|------------------|------|--------|-------------|
| 2026-06-04 | заказчик B1.7 | cart / каталог / `#/product` | **BR-5 регрессия:** второй товар — баннер/DOM корзины | **in_progress** · код `[x]` · Fly `[ ]` | [b17_br5_regression_repro_2026-06-04.json](artifacts/demo-feedback/b17_br5_regression_repro_2026-06-04.json) |
