...
| 91 | **PWA auth phone input UI/UX (UI-EXT)** | EXT #89: phone-auth — скрыть CTA суммы + cart preview; тоньше sheet; без Callcheck/SMS | **SPEC `[x]`** 2026-09-16 · ждёт `/sbr` | [TASK-89-UI-EXT-…](customer_tasks/TASK-89-UI-EXT-UI-UX-авторизации-PWA-экран-ввода-телефона.md) · [artifacts](../artifacts/pwa_auth_phone_input_ui_ux/) |
