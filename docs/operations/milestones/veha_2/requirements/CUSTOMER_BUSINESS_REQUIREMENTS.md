...
| Telegram bot support ЛК (#70) | **Витрина / PWA** — deep link `@code_black_support_bot` из шапки ЛК и «Написать нам»; без context/iframe/email | [ТЗ](customer_tasks/Связь%20через%20Telegram-бота%20поддержки%20в%20ЛК.md) · [`artifacts/telegram_bot_support_lk/`](../artifacts/telegram_bot_support_lk/) | **intake+SPEC `[x]`** 2026-08-26 · RED `[ ]` |
...
| 70 | **Telegram bot support ЛК** | Deep link `https://t.me/code_black_support_bot` из иконки чата ЛК и «Написать нам»; один URL; без user/order params, iframe, email-логики | **intake+SPEC `[x]`** 2026-08-26 · RED `[ ]` | [Связь через Telegram-бота поддержки в ЛК.md](customer_tasks/Связь%20через%20Telegram-бота%20поддержки%20в%20ЛК.md) · [artifacts](../artifacts/telegram_bot_support_lk/) |
