...
| SBP autopay checkbox default checked | **Эквайринг / PWA** — доп к #34: чекбокс «Привязать счет…» checked по умолчанию; снятие → `save_sbp_account=false`; без сброса после UI-redraw | [ТЗ](customer_tasks/Предустановленный%20чекбокс%20автоплатежа%20СБП.md) · [`artifacts/sbp_autopay_checkbox_default_checked/`](../artifacts/sbp_autopay_checkbox_default_checked/) | **интейк `[x]`** 2026-08-13 · код `[ ]` |
...
| 62 | **SBP autopay checkbox default checked** | Доп к #34: чекбокс привязки СБП checked по умолчанию; uncheck → `save_sbp_account=false`; без сброса после UI-redraw; backend не трогаем | **интейк `[x]`** 2026-08-13 · код `[ ]` | [Предустановленный чекбокс автоплатежа СБП](customer_tasks/Предустановленный%20чекбокс%20автоплатежа%20СБП.md) · [artifacts](../artifacts/sbp_autopay_checkbox_default_checked/) |
