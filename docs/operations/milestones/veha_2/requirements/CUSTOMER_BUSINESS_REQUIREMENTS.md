...
| Email after pay Callcheck (#71) | **Витрина / PWA** — QA reopen: после сбора email для чека — **не спрашивать** на следующих (только LS receipt) | [ТЗ](customer_tasks/Email-сбор%20после%20оплаты%20(Callcheck-флоу).md) · [`artifacts/email_collection_after_payment/`](../artifacts/email_collection_after_payment/) | **REVIEW** 2026-09-06 · CI · deploy апрув · Fly MCP |
