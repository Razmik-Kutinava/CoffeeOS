...
| TASK_93 Critical path hardening (#93) | **Деньги / витрина / ops** — зонтик A–L; **A** SPEC todo (деньги↔заказ); **B** Checkout identity intake | [зонтик](customer_tasks/TASK-93-Critical-path-hardening.md) · [B](customer_tasks/TASK-93-B-Checkout-identity.md) · [`artifacts/critical_path_hardening/`](../artifacts/critical_path_hardening/) · [GATES A](../artifacts/critical_path_hardening/GATES.md) | **SPEC A** 2026-09-18 · Next A: `/sbr` · B: `/spec` |
