...
| Checkout payment | **Выбор оплаты / прикрепление карты** — peek / expanded / expanded+ | [ТЗ](customer_tasks/Выбор%20способа%20оплаты%20и%20прикрепление%20банковской%20карты%20на%20экране%20оформления%20заказа.md) | этап 0 **`[x]`** 2026-07-10 · код `[ ]` · clean slate · API B1.12 |
...
**Следующий фокус по задачам заказчика:** **B1.12** A1 живая оплата · **Checkout payment** (после `go`) · **B1.13 S4** · **B1.14-4** · **B2.2** · **B1.4** iOS backlog.
