...
| Email after pay Callcheck (#71) | **Витрина / PWA** — убрать email/OTP-гейт с оплаты; опциональный email на success для чека/CRM; без OTP email | [ТЗ](customer_tasks/Email-сбор%20после%20оплаты%20(Callcheck-флоу).md) · [`artifacts/email_collection_after_payment/`](../artifacts/email_collection_after_payment/) | **intake** 2026-08-26 · SPEC → |
