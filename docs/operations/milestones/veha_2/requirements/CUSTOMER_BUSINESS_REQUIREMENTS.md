...
| Card binding unique hash (#74) | **Security / платежи** — одна карта → один аккаунт: `card_hash`, unique active constraint, нейтральный отказ без утечки `card_masked`/BIN/банка; race на уровне БД | [ТЗ](customer_tasks/Устранение%20утечки%20данных%20чужой%20карты%20при%20привязке.md) · [`artifacts/card_binding_unique_hash/`](../artifacts/card_binding_unique_hash/) | **intake** 2026-08-27 · ждёт `/spec` |
