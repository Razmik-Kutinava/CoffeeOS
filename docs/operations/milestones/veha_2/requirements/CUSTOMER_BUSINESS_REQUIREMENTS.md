...
| 86 | **SBP PWA recovery after bank** | Восстановление PWA после СБП/банка (return + cold start); device Android+iOS; без SMS/каскада; без надписей автоплатежа (#79) | **intake `[x]`** 2026-09-15 · Spec Google · ждёт `/spec` | [TASK-86-…](customer_tasks/TASK-86-Восстановление%20PWA%20после%20оплаты%20СБП-EXT.md) · [artifacts](../artifacts/sbp_pwa_recovery_after_bank_ext/) |
