...
| Phone OTP SMS/Flash Call | **Витрина / PWA** — вход и регистрация по телефону (SMS / Flash Call) + антиспам cooldown | [ТЗ](customer_tasks/Вход%20и%20регистрация%20по%20номеру%20телефона%20SMS%20Flash%20Call.md) · [`artifacts/phone_otp_sms_flash_call/`](../artifacts/phone_otp_sms_flash_call/) | **интейк `[x]`** 2026-07-24 · SPEC `[ ]` ждёт go |
...
| 24 | **Phone OTP SMS/Flash Call** | Вход/регистрация по телефону (SMS / Flash Call) + cooldown | **интейк `[x]`** 2026-07-24 · SPEC `[ ]` | [Вход и регистрация по номеру телефона…](customer_tasks/Вход%20и%20регистрация%20по%20номеру%20телефона%20SMS%20Flash%20Call.md) |
