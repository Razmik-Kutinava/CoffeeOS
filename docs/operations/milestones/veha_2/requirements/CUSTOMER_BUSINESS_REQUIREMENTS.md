...
| 90 | **Callcheck return → continue payment (POSTCALL-EXT)** | EXT #89: return из телефона → resume Callcheck → auth → PaymentMethodsSheet; без UI-EXT / backend | **ROLLED BACK** 2026-09-16 · код снят · сначала UI-EXT | [TASK-89-POSTCALL-EXT-…](customer_tasks/TASK-89-POSTCALL-EXT-Возврат%20в%20PWA%20после%20Callcheck%20и%20продолжение%20оплаты.md) · [artifacts](../artifacts/pwa_callcheck_return_continue_payment/) |
| 91 | **PWA auth phone input UI/UX (UI-EXT)** | EXT #89: phone-auth — скрыть CTA суммы + cart preview; тоньше sheet; без Callcheck/SMS | **intake** 2026-09-16 · ждёт `/spec` | [TASK-89-UI-EXT-…](customer_tasks/TASK-89-UI-EXT-UI-UX-авторизации-PWA-экран-ввода-телефона.md) · [artifacts](../artifacts/pwa_auth_phone_input_ui_ux/) |
