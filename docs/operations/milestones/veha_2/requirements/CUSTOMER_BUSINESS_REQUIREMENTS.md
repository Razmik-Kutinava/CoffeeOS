...
**Следующий фокус по задачам заказчика:** прогон B1.7 заказчиком → **блок 2** (табло баристы).
...
|-------|--------|---------|
| **1 Приём** | Оплата §2.3, W1.1–W1.5, **B1.1**, онбординг | backlog B1.2–B1.7 (юр., чек, PWA, B1.7 прогон…) |
