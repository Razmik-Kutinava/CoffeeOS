...
| 89 | **PWA auth registration Callcheck → SMS** | Callcheck→SMS; linker/session; post-call → PWA checkout + экран оплаты; overlap #80 UI | **intake `[x]`** 2026-09-16 · ждёт `/spec` | [TASK-89-…](customer_tasks/TASK-89-Авторизация-регистрация-PWA-Callcheck-SMS.md) · [artifacts](../artifacts/pwa_auth_registration_callcheck_sms/) |
