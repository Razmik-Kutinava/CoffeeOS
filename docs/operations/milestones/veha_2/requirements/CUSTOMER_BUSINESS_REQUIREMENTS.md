...
| Cascade SMS ready + status sheet stuck (#82) | **Витрина / уведомления + PWA** — п.10: SMS-каскад после `ready` не работает (reopen #39); статусная модель не скрывается на гл. экране после «готов» на табло (reopen #35/#63) | [ТЗ](customer_tasks/Каскад%20SMS%20после%20Заказ%20готов%20и%20шторка%20статуса%20на%20главном.md) · [`artifacts/order_ready_cascade_sms_status_sheet_fix/`](../artifacts/order_ready_cascade_sms_status_sheet_fix/) | **intake** 2026-09-07 · SPEC `[ ]` |
...
| 82 | **Cascade SMS ready + status sheet stuck** | П.10: SMS после «заказ готов» не работает (reopen #39); шторка статуса остаётся на гл. экране после «готов» на табло (reopen #35/#63) | **intake** 2026-09-07 · SPEC `[ ]` | [Каскад SMS после Заказ готов…](customer_tasks/Каскад%20SMS%20после%20Заказ%20готов%20и%20шторка%20статуса%20на%20главном.md) · [artifacts](../artifacts/order_ready_cascade_sms_status_sheet_fix/) |
