...
| 93 | **Post-pay auto return → catalog + status (TASK_91)** | п.9.2: после email/Skip на payment-result → авто `#/` + существующая статусная модель; защита #71 no immediate redirect | **intake** 2026-09-17 · ждёт `/spec` | [TASK-91-…](customer_tasks/TASK-91-Автоматический-возврат-на-каталог-после-post-pay-email.md) · [artifacts](../artifacts/post_pay_auto_return_catalog_status/) |
