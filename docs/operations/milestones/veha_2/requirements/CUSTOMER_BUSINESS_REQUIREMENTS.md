...
| Order status OS detect + Wallet/WebPush | **Витрина / PWA** — адаптивный нижний бар: детекция ОС → Apple Wallet (iOS) / FCM Push (Android/Desktop) + «Состав заказа» | [ТЗ](customer_tasks/Адаптивный%20виджет%20статуса%20заказа%20Детекция%20ОС%20и%20подписка%20на%20уведомления.md) · [`artifacts/order_status_os_detect_wallet_webpush/`](../artifacts/order_status_os_detect_wallet_webpush/) | **SPEC `[x]`** 2026-08-03 · RED `[ ]` |
...
| 37 | **Order status OS detect + Wallet/WebPush** | Нижний бар статуса: `getDeviceOS` → Wallet (iOS) / FCM Push (Android/Desktop) + чек «Состав заказа» | **SPEC `[x]`** 2026-08-03 · RED `[ ]` | [Адаптивный виджет статуса…](customer_tasks/Адаптивный%20виджет%20статуса%20заказа%20Детекция%20ОС%20и%20подписка%20на%20уведомления.md) |
