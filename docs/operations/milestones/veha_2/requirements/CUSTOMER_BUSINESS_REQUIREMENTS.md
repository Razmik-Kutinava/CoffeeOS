...
| 87 | **Quick Repeat status composition** | Quick Repeat one-click → Order в status model + состав; 7.1 после card autopay убрать интерактивный блок корзины | **SPEC `[x]`** 2026-09-15 · ждёт `/sbr` | [TASK-87-…](customer_tasks/TASK-87-Quick-Repeat-status-model-composition.md) · [artifacts](../artifacts/quick_repeat_status_model_composition/) |
