...
| SBP return + autopay labels (#79) | **Эквайринг / PWA** — остаток CODE:BLACK: надписи статусов автоплатежа сломаны; экран после возврата из банк-приложения (Android); тест iOS; оплаты 11/8 СБП; гипотеза SMS на гл. экран со статусами | [ТЗ](customer_tasks/Надписи%20автоплатежа%20и%20экран%20после%20возврата%20из%20банка%20СБП.md) · [`artifacts/sbp_return_status_screen_autopay_labels/`](../artifacts/sbp_return_status_screen_autopay_labels/) | **REVIEW** 2026-09-07 · push/CI · MCP после deploy |
...
| Status sheet receipt restore (#84) | **Витрина / PWA** — вернуть состав чека + CTA «Состав заказа» в статусную шторку; reverse QA `7ab3f3e6`; без dismiss/`orderStatusSheet` | [ТЗ](customer_tasks/TASK-84-status-sheet-receipt-restore.md) · [`artifacts/status_sheet_receipt_restore/`](../artifacts/status_sheet_receipt_restore/) | **REVIEW** 2026-09-13 · push/CI · deploy апрув |
...
| 84 | **Status sheet receipt restore** | Вернуть состав чека + CTA «Состав заказа» в шторку; `receiptView` / `openOrderReceipt`; без `aoa__dismiss` / `orderStatusSheet` | **REVIEW** 2026-09-13 · push/CI · deploy апрув | [TASK-84-status-sheet-receipt-restore.md](customer_tasks/TASK-84-status-sheet-receipt-restore.md) · [artifacts](../artifacts/status_sheet_receipt_restore/) |
