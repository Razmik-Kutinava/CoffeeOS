...
| # | Что | Зачем | Приоритет |
|---|-----|-------|-----------|
| B1.1 | **Уведомления гостю** — экран статуса + прогресс-бар | [ТЗ](customer_tasks/B1_1_order_status_progress.md) · PDF §1.7 | **высокий** · этапы 0–1 `[x]` · 2–4 `[ ]` |
...
| 2 | **B1.1** | Экран уведомления заказа + прогресс-бар | этапы 0–1 `[x]` · WS/отмена `[ ]` | [B1_1_order_status_progress.md](customer_tasks/B1_1_order_status_progress.md) |
