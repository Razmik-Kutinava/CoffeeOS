...
| 33 | **T-Kassa Widget One-Click + Fallback** | Виджет Т-Кассы SDK (connection_type: Widget) + One-Click + fallback СБП/карта при отказе | **GREEN `[x]`** 2026-08-07 fallback≠expanded · push/MCP `[ ]` | [Интеграция виджета быстрой оплаты…](customer_tasks/Интеграция%20виджета%20быстрой%20оплаты%20Т-Кассы%20и%20One-Click%20сценария%20в%20PWA.md) |
