...
| 34 | **T-Kassa SBP Autopay AccountToken** | Автоплатежи СБП: Setup + webhook `AccountToken` + Zero-Click `ChargeQr` + fallback | **SPEC `[x]`** 2026-07-30 · RED `[ ]` | [Интеграция Автоплатежей СБП…](customer_tasks/Интеграция%20Автоплатежей%20СБП%20Т-Касса%20в%20PWA.md) |
