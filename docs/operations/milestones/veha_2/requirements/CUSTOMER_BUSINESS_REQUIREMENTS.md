...
| # | Что | Зачем | Приоритет |
|---|-----|-------|-----------|
| B1.1 | **Уведомления гостю** — экран статуса + прогресс-бар | [ТЗ](customer_tasks/B1_1_order_status_progress.md) · PDF §1.7 | **высокий** · этапы 0–2 `[x]` · 3–4 `[ ]` |
...
| 2 | **B1.1** | Экран уведомления заказа + прогресс-бар | этапы 0–2 `[x]` · отмена/приёмка `[ ]` | [B1_1_order_status_progress.md](customer_tasks/B1_1_order_status_progress.md) |
