...
| Repeat order invalid token payment sheet | **Витрина** — G7 NewCardForm + UI скрин 03 (G1–G4) | [ТЗ](customer_tasks/Главный%20экран%20—%20повторный%20заказ%20(невалидный%20токен)%20BottomSheet%20выбора%20способа%20оплаты.md) · [`artifacts/…`](../artifacts/repeat_order_invalid_token_payment_sheet/) · MCP [`fly_v439`](../artifacts/repeat_order_invalid_token_payment_sheet/mcp/fly_v439_2026-08-07/) | **MCP G1–G4 PASS `[x]`** Fly v439 · G7 live PARTIAL · апрув заказчика `[ ]` |
