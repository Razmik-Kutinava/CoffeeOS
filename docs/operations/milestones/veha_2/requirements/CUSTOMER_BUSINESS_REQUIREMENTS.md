...
| Repeat order invalid token payment sheet | **Витрина** — G7 NewCardForm + UI скрин 03/09 (G1–G4) | [ТЗ](customer_tasks/Главный%20экран%20—%20повторный%20заказ%20(невалидный%20токен)%20BottomSheet%20выбора%20способа%20оплаты.md) · [`artifacts/…`](../artifacts/repeat_order_invalid_token_payment_sheet/) · скрин `09_…_2026-08-13` | **GREEN local** 2026-08-13 · MCP `[ ]` · апрув `[ ]` |
...
| 26 | **Repeat order invalid token payment sheet** | G7 NewCardForm + UI скрин 03 | **MCP G1–G4 PASS `[x]`** Fly v439 · G7 PARTIAL · апрув `[ ]` | [Главный экран — повторный заказ…](customer_tasks/Главный%20экран%20—%20повторный%20заказ%20(невалидный%20токен)%20BottomSheet%20выбора%20способа%20оплаты.md) |
