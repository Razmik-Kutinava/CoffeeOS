...
| TASK_93 Critical path hardening (#93) | **Деньги / витрина / ops** — зонтик A–L; **сейчас TASK_93-A**: банк CONFIRMED → всегда `payment.succeeded` + `order.accepted`; склад не откатывает оплату; blank Amount / cancelled+succeeded — не silent | [ТЗ](customer_tasks/TASK-93-Critical-path-hardening.md) · [`artifacts/critical_path_hardening/`](../artifacts/critical_path_hardening/) | **intake** 2026-09-18 · блок A · Next: `/spec` |
