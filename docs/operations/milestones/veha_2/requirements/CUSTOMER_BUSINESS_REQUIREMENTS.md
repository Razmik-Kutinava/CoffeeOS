...
| 33 | **T-Kassa Widget One-Click + Fallback** | Виджет Т-Кассы SDK (connection_type: Widget) + One-Click + fallback СБП/карта при отказе | **SPEC 2026-08-07** fallback≠expanded (скрины 07/08) · апрув `[ ]` | [Интеграция виджета быстрой оплаты…](customer_tasks/Интеграция%20виджета%20быстрой%20оплаты%20Т-Кассы%20и%20One-Click%20сценария%20в%20PWA.md) |
...
| 46 | **Bank auth limit blocks payment** | Сбой банка: «Превышено допустимое количество запросов авторизации» → нельзя оплатить / сменить статусы; СБП | **GREEN `[x]`** 2026-08-07 · push/MCP `[ ]` | [Сбой банка не могу оплатить…](customer_tasks/Сбой%20банка%20не%20могу%20оплатить%20заказ%20для%20статусов.md) · [artifacts](../artifacts/bank_auth_limit_blocks_payment/) |
