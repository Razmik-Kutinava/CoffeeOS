...
| TASK_93 Critical path hardening (#93) | **Деньги / витрина / ops** — зонтик A–L; **сейчас TASK_93-B**: Checkout identity phone-first (UI Pay ≡ бэкенд без 422 email); A — intake, ждёт `/spec` | [зонтик](customer_tasks/TASK-93-Critical-path-hardening.md) · [B](customer_tasks/TASK-93-B-Checkout-identity.md) · [`artifacts/critical_path_hardening/`](../artifacts/critical_path_hardening/) | **intake** 2026-09-18 · блок B · Next: `/spec` |
