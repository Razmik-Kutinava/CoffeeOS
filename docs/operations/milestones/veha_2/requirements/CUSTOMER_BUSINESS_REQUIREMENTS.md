...
| Repeat hidden by stale active orders | **Витрина / PWA** — после #42 нет «повторить» / кнопок на карточках / истории частот (June accepted → has_active_order) | [ТЗ](customer_tasks/После%2042%20пропали%20повторы%20в%20шторке%20и%20история%20покупок.md) · [`artifacts/repeat_hidden_by_stale_active_orders/`](../artifacts/repeat_hidden_by_stale_active_orders/) | **интейк `[x]`** 2026-08-06 · follow-up #42 |
