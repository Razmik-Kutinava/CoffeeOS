...
| TASK_93 Critical path hardening (#93) | **Деньги / витрина / ops** — зонтик A–L; **B** SPEC phone-first Checkout identity; A/C/D параллельно | [зонтик](customer_tasks/TASK-93-Critical-path-hardening.md) · [B](customer_tasks/TASK-93-B-Checkout-identity.md) · [`artifacts/critical_path_hardening/`](../artifacts/critical_path_hardening/) · [GATES B](../artifacts/critical_path_hardening/GATES-block-B.md) | **SPEC B** 2026-09-18 · Next B: `/sbr` |
