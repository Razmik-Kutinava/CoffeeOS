...
| TASK_93 Critical path hardening (#93) | **Деньги / витрина / ops** — зонтик A–L; **A** REVIEW done (деньги↔заказ); B/C… параллельно | [зонтик](customer_tasks/TASK-93-Critical-path-hardening.md) · [B](customer_tasks/TASK-93-B-Checkout-identity.md) · [`artifacts/critical_path_hardening/`](../artifacts/critical_path_hardening/) · [TODO A](../artifacts/critical_path_hardening/TODO-block-A.md) | **REVIEW A** 2026-09-18 · CI green · deploy=L |
