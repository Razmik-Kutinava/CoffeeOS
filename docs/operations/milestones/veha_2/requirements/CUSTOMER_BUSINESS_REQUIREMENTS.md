...
| Status inside cart sheet | **Витрина / PWA** — блок статуса активных заказов **внутри** шторки корзины (не fixed-слой поверх) | [ТЗ](customer_tasks/Статус%20заказа%20внутри%20шторки%20корзины%20не%20слой%20поверх.md) · [`artifacts/status_inside_cart_sheet/`](../artifacts/status_inside_cart_sheet/) | **интейк `[x]`** 2026-07-31 · SPEC/код в том же шаге |
