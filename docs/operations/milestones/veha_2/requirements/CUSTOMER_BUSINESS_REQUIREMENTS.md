...
| Shop Telegram/Instagram in-app open | **Витрина** — `/shop?tenant_id=` открывается во встроенных браузерах Telegram и Instagram без копирования в Chrome/Safari; без вечного shop-boot-skeleton | [ТЗ](customer_tasks/Исправление%20открытия%20shop%20во%20встроенных%20браузерах%20Telegram%20и%20Instagram.md) · [`artifacts/shop_telegram_instagram_inapp_browser/`](../artifacts/shop_telegram_instagram_inapp_browser/) | **интейк + SPEC `[x]`** 2026-08-14 · диагностика `[ ]` |
...
| 64 | **Shop Telegram/Instagram in-app open** | `/shop?tenant_id=` во встроенных браузерах Telegram/Instagram Android+iOS; без вечного skeleton; фикс только по доказанной точке отказа | **интейк + SPEC `[x]`** 2026-08-14 · диагностика `[ ]` | [Исправление открытия shop…](customer_tasks/Исправление%20открытия%20shop%20во%20встроенных%20браузерах%20Telegram%20и%20Instagram.md) · [artifacts](../artifacts/shop_telegram_instagram_inapp_browser/) |
