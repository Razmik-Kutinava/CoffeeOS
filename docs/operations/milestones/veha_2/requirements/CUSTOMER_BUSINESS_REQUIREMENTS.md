...
**Следующий фокус по задачам заказчика:** **B1.11** (ответы Q1–Q10) · **B2.2** · апрувы B2-S1 / B1.4 `[ ]`.
...
|-------|--------|---------|
| **1 Приём** | Оплата §2.3, W1.1–W1.5, **B1.1**, **B1.7 checkout** | **B1.11** ТЗ · **B1.4 PWA** · B1.2–B1.3 |
