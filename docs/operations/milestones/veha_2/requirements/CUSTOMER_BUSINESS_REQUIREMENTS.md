...
| PWA ЛК (#69) | **Витрина / PWA** — hub ЛК: история заказов, детали, настройки, «О нас», bottom sheet поддержки | [ТЗ](customer_tasks/Доработка%20личного%20кабинета%20(ЛК)%20в%20PWA.md) · [`artifacts/pwa_personal_account_lk/`](../artifacts/pwa_personal_account_lk/) | **intake `[x]`** 2026-08-26 · SPEC `[ ]` |
...
| 69 | **PWA ЛК** | Доработка личного кабинета: hub с историей, детали заказа, настройки/контакты, «О нас», поддержка; без ОФД/PLG/subscription | **intake `[x]`** 2026-08-26 · SPEC `[ ]` | [Доработка личного кабинета (ЛК) в PWA.md](customer_tasks/Доработка%20личного%20кабинета%20(ЛК)%20в%20PWA.md) · [artifacts](../artifacts/pwa_personal_account_lk/) |
