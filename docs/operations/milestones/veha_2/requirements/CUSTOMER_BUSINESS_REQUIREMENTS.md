...
| 38 | **Background FCM progress + Apple Wallet** | FCM tag/actions/прогресс + SW; `.pkpass` + APNs update; PWA UI state machine (макс. 2 CTA); без правок Barista status | **SPEC `[x]`** 2026-08-03 · код `[ ]` | [Фоновые уведомления прогресс-бар…](customer_tasks/Фоновые%20уведомления%20прогресс-бар%20Android%20FCM%20и%20Apple%20Wallet%20iOS.md) |
