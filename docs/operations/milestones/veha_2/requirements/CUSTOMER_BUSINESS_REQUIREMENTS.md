...
| Shop Telegram/Instagram in-app open | **Витрина** — `/shop?tenant_id=` открывается во встроенных браузерах Telegram и Instagram без копирования в Chrome/Safari; без вечного shop-boot-skeleton | [ТЗ](customer_tasks/Исправление%20открытия%20shop%20во%20встроенных%20браузерах%20Telegram%20и%20Instagram.md) · [`artifacts/shop_telegram_instagram_inapp_browser/`](../artifacts/shop_telegram_instagram_inapp_browser/) | **GREEN local** 2026-08-14 · MCP/TG-IG `[ ]` |
| Telegram/Instagram In-App → /shop linkage | **Витрина** — связка перехода TG/IG In-App → `/shop` + `/shop/api/categories`; tenant_id без подмены; error/cache fallback; без auth через UA/TG identity | [ТЗ](customer_tasks/Изменения%20в%20связке%20Telegram%20Instagram%20In-App%20Browser%20к%20CoffeeOS%20shop.md) · [`artifacts/telegram_instagram_inapp_shop_linkage/`](../artifacts/telegram_instagram_inapp_shop_linkage/) | **GREEN local** 2026-08-14 · MCP/TG-IG `[ ]` |
| Telegram WebView storefront runtime | **Витрина** — полноценная работа `/shop` внутри Telegram In-App Browser: mount/API/storage/tenant/nav/viewport fallback; без bot/auth/payments | [ТЗ](customer_tasks/Полноценная%20работа%20мобильной%20витрины%20CoffeeOS%20внутри%20Telegram%20In-App%20Browser.md) · [`artifacts/mobile_storefront_telegram_webview/`](../artifacts/mobile_storefront_telegram_webview/) | **CI green** 2026-08-15 · MCP/TG `[ ]` · deploy апрув |
| Telegram WebView mobile UI | **Витрина** — адаптация Mobile UI `/shop` под Telegram WebView: visual viewport, sticky, CartSheet, safe-area, keyboard; без backend/bot/#66 runtime | [ТЗ](customer_tasks/Адаптация%20Mobile%20UI%20витрины%20CoffeeOS%20под%20Telegram%20WebView.md) · [`artifacts/mobile_storefront_telegram_webview_ui/`](../artifacts/mobile_storefront_telegram_webview_ui/) | **CI green** 2026-08-15 · MCP/TG `[ ]` · deploy апрув |
| Telegram WebView UX / Performance | **Витрина** — skeleton/SWR/lazy images/retry/offline; без backend, bot, повторного #66/#67 | [ТЗ](customer_tasks/UX%20и%20Performance%20мобильной%20витрины%20CoffeeOS%20внутри%20Telegram%20WebView.md) · [`artifacts/mobile_storefront_telegram_webview_ux_perf/`](../artifacts/mobile_storefront_telegram_webview_ux_perf/) | **CI green** 2026-08-15 · MCP/TG `[ ]` · deploy апрув |
...
| 64 | **Shop Telegram/Instagram in-app open** | `/shop?tenant_id=` во встроенных браузерах Telegram/Instagram Android+iOS; без вечного skeleton; фикс только по доказанной точке отказа | **GREEN local** 2026-08-14 · MCP/TG-IG `[ ]` | [Исправление открытия shop…](customer_tasks/Исправление%20открытия%20shop%20во%20встроенных%20браузерах%20Telegram%20и%20Instagram.md) · [artifacts](../artifacts/shop_telegram_instagram_inapp_browser/) |
| 65 | **Telegram/Instagram In-App → /shop linkage** | Связка TG/IG In-App → `/shop` + categories API; tenant_id integrity; error/cache fallback; без auth через UA/TG; без forced redirect | **GREEN local** 2026-08-14 · MCP/TG-IG `[ ]` | [Изменения в связке Telegram Instagram…](customer_tasks/Изменения%20в%20связке%20Telegram%20Instagram%20In-App%20Browser%20к%20CoffeeOS%20shop.md) · [artifacts](../artifacts/telegram_instagram_inapp_shop_linkage/) |
| 66 | **Telegram WebView storefront runtime** | Полноценная работа мобильной витрины внутри Telegram In-App Browser: JS/Svelte/API/CORS/CSP/cookies/storage/tenant/nav/viewport; без bot/payments | **CI green** 2026-08-15 · MCP/TG `[ ]` · deploy апрув | [Полноценная работа мобильной витрины…](customer_tasks/Полноценная%20работа%20мобильной%20витрины%20CoffeeOS%20внутри%20Telegram%20In-App%20Browser.md) · [artifacts](../artifacts/mobile_storefront_telegram_webview/) |
| 67 | **Telegram WebView mobile UI** | Адаптация Mobile UI витрины под Telegram WebView: visual viewport / sticky / CartSheet / safe-area / keyboard; без backend, bot, повторного #66 runtime | **CI green** 2026-08-15 · MCP/TG `[ ]` · deploy апрув | [Адаптация Mobile UI витрины…](customer_tasks/Адаптация%20Mobile%20UI%20витрины%20CoffeeOS%20под%20Telegram%20WebView.md) · [artifacts](../artifacts/mobile_storefront_telegram_webview_ui/) |
| 68 | **Telegram WebView UX / Performance** | UX+perf витрины в Telegram WebView: skeleton, SWR cache по tenant, lazy images, retry/offline, network vs HTTP; без backend, bot, #66 runtime, #67 layout | **CI green** 2026-08-15 · MCP/TG `[ ]` · deploy апрув | [UX и Performance мобильной витрины…](customer_tasks/UX%20и%20Performance%20мобильной%20витрины%20CoffeeOS%20внутри%20Telegram%20WebView.md) · [artifacts](../artifacts/mobile_storefront_telegram_webview_ux_perf/) |
