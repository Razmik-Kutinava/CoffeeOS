...
| 66 | **Telegram WebView storefront runtime** | Полноценная работа мобильной витрины внутри Telegram In-App Browser: JS/Svelte/API/CORS/CSP/cookies/storage/tenant/nav/viewport; без bot/payments | **intake** 2026-08-15 · SPEC `[ ]` | [Полноценная работа мобильной витрины…](customer_tasks/Полноценная%20работа%20мобильной%20витрины%20CoffeeOS%20внутри%20Telegram%20In-App%20Browser.md) · [artifacts](../artifacts/mobile_storefront_telegram_webview/) |
