...
**Следующий фокус по задачам заказчика:** **B2.2** · апрувы B1.9 / B2-S1 / B2.1 `[ ]`.
...
|-------|--------|---------|
| **1 Приём** | Оплата §2.3, W1.1–W1.5, **B1.1**, **B1.7 checkout** | **B1.4 PWA** (ТЗ) · B1.2–B1.3 |
...
- **Статус:** B2.1 ревизия OPS CLOSED 2026-06-13 · B2-S1 **done** · B2.2 ТЗ `[x]` · код B2.2 `[ ]`.
