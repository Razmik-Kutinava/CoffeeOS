...
| Telegram WebView UX / Performance | **Витрина** — skeleton/SWR/lazy images/retry/offline; без backend, bot, повторного #66/#67 | [ТЗ](customer_tasks/UX%20и%20Performance%20мобильной%20витрины%20CoffeeOS%20внутри%20Telegram%20WebView.md) · [`artifacts/mobile_storefront_telegram_webview_ux_perf/`](../artifacts/mobile_storefront_telegram_webview_ux_perf/) | **intake + SPEC** 2026-08-15 · RED `[ ]` |
...
| 68 | **Telegram WebView UX / Performance** | UX+perf витрины в Telegram WebView: skeleton, SWR cache по tenant, lazy images, retry/offline, network vs HTTP; без backend, bot, #66 runtime, #67 layout | **intake + SPEC** 2026-08-15 · RED `[ ]` | [UX и Performance мобильной витрины…](customer_tasks/UX%20и%20Performance%20мобильной%20витрины%20CoffeeOS%20внутри%20Telegram%20WebView.md) · [artifacts](../artifacts/mobile_storefront_telegram_webview_ux_perf/) |
