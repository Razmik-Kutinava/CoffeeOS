...
| 25 | **Profile Email↔Phone merge** | Связка Email↔Phone, soft-merge, UI профиля / автозаполнение checkout | **интейк + SPEC `[x]`** 2026-07-27 · RED `[ ]` | [Связка профилей Email Phone…](customer_tasks/Связка%20профилей%20Email%20Phone%20и%20управление%20данными%20пользователя%20в%20PWA.md) |
