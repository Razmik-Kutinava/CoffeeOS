...
| Auth funnel cascade Flash Call×2 → SMS.ru | **Витрина / PWA** — 2-экрановый wizard + каскад Flash Call×2 → СМС (без Email/радиоканалов) | [ТЗ](customer_tasks/Рефакторинг%20воронки%20авторизации%20PWA%20Каскад%20Flash%20Call%20x2%20SMS%20на%20базе%20SMS.ru.md) · [`artifacts/auth_funnel_flash_call_x2_sms_ru/`](../artifacts/auth_funnel_flash_call_x2_sms_ru/) | **интейк `[x]`** 2026-07-29 · SPEC `[ ]` ждёт go |
