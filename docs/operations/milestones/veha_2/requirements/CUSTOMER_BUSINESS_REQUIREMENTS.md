...
| Repeat order invalid token payment sheet | **Витрина** — QA reopen 2026-09-06: шаг 5 inline при отказе банка («попробуйте другую карту») | [ТЗ](customer_tasks/Главный%20экран%20—%20повторный%20заказ%20(невалидный%20токен)%20BottomSheet%20выбора%20способа%20оплаты.md) · [`artifacts/…`](../artifacts/repeat_order_invalid_token_payment_sheet/) · QA `screenshots/qa_2026-09-06/` | **QA reopen** 2026-09-06 · SPEC `[ ]` · апрув `[ ]` |
...
| Email after pay Callcheck (#71) | **Витрина / PWA** — убрать email/OTP-гейт с оплаты; опциональный email на success для чека/CRM; без OTP email | [ТЗ](customer_tasks/Email-сбор%20после%20оплаты%20(Callcheck-флоу).md) · [`artifacts/email_collection_after_payment/`](../artifacts/email_collection_after_payment/) | **REVIEW** 2026-08-26 · CI · deploy апрув · Fly MCP |
...
| 26 | **Repeat order invalid token payment sheet** | QA reopen: шаг 5 надпись при отказе банка | **QA reopen** 2026-09-06 · G1–G4 MCP `[x]` v439 · апрув `[ ]` | [Главный экран — повторный заказ…](customer_tasks/Главный%20экран%20—%20повторный%20заказ%20(невалидный%20токен)%20BottomSheet%20выбора%20способа%20оплаты.md) |
