...
| Phone OTP Flash Call | **Витрина / PWA** — вход только Flash Call (`code/call`) | [ТЗ](customer_tasks/Вход%20по%20телефону%20Flash%20Call%20OTP.md) · [`artifacts/phone_otp_flash_call/`](../artifacts/phone_otp_flash_call/) | **GREEN `[x]`** 2026-08-12 · MCP `[ ]` |
| Phone OTP SMS | **Витрина / PWA** — вход только SMS (свой код, без flash) | [ТЗ](customer_tasks/Вход%20по%20телефону%20SMS%20OTP.md) · [`artifacts/phone_otp_sms/`](../artifacts/phone_otp_sms/) | **GREEN `[x]`** 2026-08-12 · MCP `[ ]` |
