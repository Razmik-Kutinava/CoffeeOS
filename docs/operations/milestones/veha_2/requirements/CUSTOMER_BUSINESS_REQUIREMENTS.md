...
| Svelte 5 status widget reactivity UX | **Витрина / PWA** — доп к #35: иммутабельный Cable→state (Svelte 5), `userDismissed` + X, скрытие на product/profile/pay | [ТЗ](customer_tasks/Исправление%20реактивности%20Svelte%205%20и%20UX%20управления%20статусным%20виджетом.md) · [`artifacts/svelte5_status_widget_reactivity_ux/`](../artifacts/svelte5_status_widget_reactivity_ux/) | **GREEN local** 2026-08-13 · MCP `[ ]` · апрув `[ ]` |
...
| 63 | **Svelte 5 status widget reactivity UX** | Доп к #35: иммутабельный applyCableEvent/sync; `userDismissed` + X; скрытие виджета на `#/product` / `#/profile` / pay; Cable живёт после dismiss | **GREEN local** 2026-08-13 · MCP `[ ]` · апрув `[ ]` | [Исправление реактивности Svelte 5…](customer_tasks/Исправление%20реактивности%20Svelte%205%20и%20UX%20управления%20статусным%20виджетом.md) · [artifacts](../artifacts/svelte5_status_widget_reactivity_ux/) |
