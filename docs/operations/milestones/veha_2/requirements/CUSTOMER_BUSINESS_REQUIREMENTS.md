...
| 90 | **Callcheck return → continue payment (POSTCALL-EXT)** | EXT #89: return из телефона → resume Callcheck → auth → PaymentMethodsSheet; без UI-EXT / backend | **intake `[x]`** 2026-09-16 · ждёт `/spec` | [TASK-89-POSTCALL-EXT-…](customer_tasks/TASK-89-POSTCALL-EXT-Возврат%20в%20PWA%20после%20Callcheck%20и%20продолжение%20оплаты.md) · [artifacts](../artifacts/pwa_callcheck_return_continue_payment/) |
