...
| B1.12 | **Рекуррент Т-Банк** — токены, 1 клик, UX оплаты (R1–R3) | [ТЗ](customer_tasks/B1_12_recurrent_payments.md) | **ТЗ этап 0** `[x]` 2026-06-18 · апрув на код `[ ]` |
| B1.11 | **Режим работы точки** — УК, витрина, табло | [ТЗ](customer_tasks/B1_11_tenant_operating_hours.md) | **ТЗ этап 0** `[x]` 2026-06-18 · апрув на код `[ ]` |
...
| 8 | **B1.11** | Режим работы точек продаж (УК) | **ТЗ этап 0** `[x]` · код `[ ]` | [B1_11_tenant_operating_hours.md](customer_tasks/B1_11_tenant_operating_hours.md) |
| 9 | **B1.12** | Рекуррент + оплата в 1 клик (витрина) | **ТЗ этап 0** `[x]` · код `[ ]` | [B1_12_recurrent_payments.md](customer_tasks/B1_12_recurrent_payments.md) |

**Следующий фокус по задачам заказчика:** **B1.12** (ответы Q1–Q7) · **B1.11** · **B2.2** · апрувы B2-S1 / B1.4 `[ ]`.
...
|-------|--------|---------|
| **1 Приём** | Оплата §2.3, W1.1–W1.5, **B1.1**, **B1.7 checkout** | **B1.12** рекуррент · **B1.11** ТЗ · **B1.4 PWA** · B1.2–B1.3 |
