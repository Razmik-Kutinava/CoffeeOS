...
| 92 | **WebPush recovery after denied (TASK_90)** | EXT #81 п.9.1: recovery UI + deep-link/fallback `denied → settings`; без backend/SW/iOS | **SPEC `[x]`** 2026-09-17 · ждёт `/sbr` | [TASK-90-…](customer_tasks/TASK-90-Восстановление-WebPush-после-запрета-уведомлений.md) · [artifacts](../artifacts/webpush_recovery_after_denied/) |
