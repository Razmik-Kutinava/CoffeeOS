...
| # | Что | Зачем | Приоритет |
|---|-----|-------|-----------|
| B1.1 | **Уведомления гостю** — экран статуса + прогресс-бар | [ТЗ](customer_tasks/B1_1_order_status_progress.md) · PDF §1.7 | **высокий** · код `[x]` внутр. PASS · заказчик `[ ]` · deploy Fly |
...
| 2 | **B1.1** | Экран уведомления заказа + прогресс-бар | внутр. PASS · заказчик `[ ]` · deploy Fly | [B1_1_order_status_progress.md](customer_tasks/B1_1_order_status_progress.md) |

**Следующий фокус по задачам заказчика:** прогон B1.7 заказчиком → реализация B1.1.
