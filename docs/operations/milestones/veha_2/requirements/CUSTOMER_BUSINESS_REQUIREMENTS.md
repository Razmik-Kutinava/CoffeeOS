...
| 45 | **Aram one-click pay SSL + cards** | Оплата в 1 клик у Арама: processing → ничего; карты то есть то нет; RebillId/Charge | **код `[x]`** 2026-08-06 · ждёт deploy/MCP | [Оплата в 1 клик у Арама…](customer_tasks/Оплата%20в%201%20клик%20у%20Арама%20падает%20после%20processing.md) · [artifacts](../artifacts/aram_one_click_payment_ssl_mintcifry/) |
