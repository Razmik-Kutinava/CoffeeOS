...
| Phone OTP SMS/Flash Call | **Витрина / PWA** — **SUPERSEDED** смешанный ТЗ → Flash Call OTP + SMS OTP отдельно | [старый ТЗ](customer_tasks/Вход%20и%20регистрация%20по%20номеру%20телефона%20SMS%20Flash%20Call.md) | **superseded** 2026-08-12 |
| Phone OTP Flash Call | **SUPERSEDED** — не канон; auth = Callcheck | [ТЗ](customer_tasks/Вход%20по%20телефону%20Flash%20Call%20OTP.md) | **superseded** 2026-08-12 BUG-REPORT |
| Phone OTP SMS | SMS **только fallback** (см. Callcheck BUG-REPORT) | [ТЗ](customer_tasks/Вход%20по%20телефону%20SMS%20OTP.md) | **partial** · fallback GREEN |
| SMS.ru auth Callcheck not FlashCall | **Critical** — заменить FlashCall на Callcheck + SMS fallback | [BUG-REPORT](customer_tasks/BUG-REPORT%20SMS.ru%20FlashCall%20вместо%20Callcheck.md) · [связка](customer_tasks/BUG-REPORT%20Изменение%20связки%20SMS.ru%20Callcheck%20SMS%20fallback.md) · [`artifacts/sms_ru_auth_callcheck_not_flash/`](../artifacts/sms_ru_auth_callcheck_not_flash/) | **GREEN local** 2026-08-12 · MCP `[ ]` |
...
| Repeat order invalid token payment sheet | **Витрина** — QA step5 inline при отказе банка | [ТЗ](customer_tasks/Главный%20экран%20—%20повторный%20заказ%20(невалидный%20токен)%20BottomSheet%20выбора%20способа%20оплаты.md) · [`artifacts/…`](../artifacts/repeat_order_invalid_token_payment_sheet/) · QA `screenshots/qa_2026-09-06/` | **REVIEW** 2026-09-06 · CI GREEN · MCP `[ ]` · апрув `[ ]` |
| UX One-Click fail → PaymentMethodsSheet expanded | **Витрина** — после ошибки One-Click открывать полную шторку «Способ оплаты» (без клипа / дублей) | [ТЗ](customer_tasks/UX%20повторная%20оплата%20после%20ошибки%20One-Click%20шторка%20способа%20оплаты.md) · [`artifacts/tbank_widget_oneclick_fallback/`](../artifacts/tbank_widget_oneclick_fallback/) · скрин `09_…_clipped_2026-08-13` | **GREEN local** 2026-08-13 · MCP `[ ]` · апрув `[ ]` |
| Payment error user messages | **Витрина** — понятные тексты при ошибке One-Click: карта vs «Нет связи. Повторить» | [ТЗ](customer_tasks/Понятные%20сообщения%20пользователю%20при%20ошибке%20оплаты.md) · [`artifacts/payment_error_user_messages/`](../artifacts/payment_error_user_messages/) | **GREEN local** 2026-08-13 · MCP `[ ]` · апрув `[ ]` |
| SBP autopay checkbox default checked | **Эквайринг / PWA** — доп к #34: чекбокс «Привязать счет…» checked по умолчанию; снятие → `save_sbp_account=false`; без сброса после UI-redraw | [ТЗ](customer_tasks/Предустановленный%20чекбокс%20автоплатежа%20СБП.md) · [`artifacts/sbp_autopay_checkbox_default_checked/`](../artifacts/sbp_autopay_checkbox_default_checked/) | **GREEN local** 2026-08-13 · MCP `[ ]` · апрув `[ ]` |
| Bank auth limit blocks payment | **Эквайринг / PWA** — лимит авторизаций банка блокирует оплату (статусы не сменяются); СБП | [ТЗ](customer_tasks/Сбой%20банка%20не%20могу%20оплатить%20заказ%20для%20статусов.md) · [`artifacts/…`](../artifacts/bank_auth_limit_blocks_payment/) · MCP [`fly_v441`](../artifacts/bank_auth_limit_blocks_payment/mcp/fly_v441_2026-08-07/) | **MCP PASS `[x]`** Fly v441 · апрув `[ ]` |
...
| Auth funnel cascade Flash Call×2 → SMS | **Витрина / PWA** — wizard Flash×2→SMS; **п. SMS=код звонка SUPERSEDED** (SMS независим) | [ТЗ](customer_tasks/Рефакторинг%20воронки%20авторизации%20PWA%20Каскад%20Flash%20Call%20x2%20SMS.md) · [`artifacts/auth_funnel_flash_call_x2_sms_ru/`](../artifacts/auth_funnel_flash_call_x2_sms_ru/) | **partial supersede** 2026-08-12 · каналы GREEN |
...
| Order status compact sheet + Push | **Витрина / PWA + POS** — виджет статуса только во время готовки; hide on `ready` + Push; home + product card | [ТЗ](customer_tasks/Интеграция%20статусной%20модели%20в%20компактную%20шторку%20PWA%20и%20Push.md) · [`artifacts/order_status_compact_sheet_push/`](../artifacts/order_status_compact_sheet_push/) | **Fly v438 MCP PASS** 2026-08-06 · апрув `[ ]` · **reopen #82** 2026-09-07 (не скрывается на гл.) |
| Svelte 5 status widget reactivity UX | **Витрина / PWA** — доп к #35: иммутабельный Cable→state (Svelte 5), `userDismissed` + X, скрытие на product/profile/pay | [ТЗ](customer_tasks/Исправление%20реактивности%20Svelte%205%20и%20UX%20управления%20статусным%20виджетом.md) · [`artifacts/svelte5_status_widget_reactivity_ux/`](../artifacts/svelte5_status_widget_reactivity_ux/) | **Fly v454 MCP PASS** 2026-08-13 · апрув `[ ]` |
| Shop Telegram/Instagram in-app open | **Витрина** — `/shop?tenant_id=` открывается во встроенных браузерах Telegram и Instagram без копирования в Chrome/Safari; без вечного shop-boot-skeleton | [ТЗ](customer_tasks/Исправление%20открытия%20shop%20во%20встроенных%20браузерах%20Telegram%20и%20Instagram.md) · [`artifacts/shop_telegram_instagram_inapp_browser/`](../artifacts/shop_telegram_instagram_inapp_browser/) | **Fly v456 MCP Chrome PASS** · TG/IG `[ ]` |
| Telegram/Instagram In-App → /shop linkage | **Витрина** — связка перехода TG/IG In-App → `/shop` + `/shop/api/categories`; tenant_id без подмены; error/cache fallback; без auth через UA/TG identity | [ТЗ](customer_tasks/Изменения%20в%20связке%20Telegram%20Instagram%20In-App%20Browser%20к%20CoffeeOS%20shop.md) · [`artifacts/telegram_instagram_inapp_shop_linkage/`](../artifacts/telegram_instagram_inapp_shop_linkage/) | **Fly v456 MCP Chrome PASS** · TG/IG `[ ]` |
| Telegram WebView storefront runtime | **Витрина** — полноценная работа `/shop` внутри Telegram In-App Browser: mount/API/storage/tenant/nav/viewport fallback; без bot/auth/payments | [ТЗ](customer_tasks/Полноценная%20работа%20мобильной%20витрины%20CoffeeOS%20внутри%20Telegram%20In-App%20Browser.md) · [`artifacts/mobile_storefront_telegram_webview/`](../artifacts/mobile_storefront_telegram_webview/) | **Fly v456 MCP Chrome PASS** · TG `[ ]` |
| Telegram WebView mobile UI | **Витрина** — адаптация Mobile UI `/shop` под Telegram WebView: visual viewport, sticky, CartSheet, safe-area, keyboard; без backend/bot/#66 runtime | [ТЗ](customer_tasks/Адаптация%20Mobile%20UI%20витрины%20CoffeeOS%20под%20Telegram%20WebView.md) · [`artifacts/mobile_storefront_telegram_webview_ui/`](../artifacts/mobile_storefront_telegram_webview_ui/) | **Fly v456 MCP PARTIAL** (S7 keyboard SKIP) · TG `[ ]` |
| Telegram WebView UX / Performance | **Витрина** — skeleton/SWR/lazy images/retry/offline; без backend, bot, повторного #66/#67 | [ТЗ](customer_tasks/UX%20и%20Performance%20мобильной%20витрины%20CoffeeOS%20внутри%20Telegram%20WebView.md) · [`artifacts/mobile_storefront_telegram_webview_ux_perf/`](../artifacts/mobile_storefront_telegram_webview_ux_perf/) | **Fly v456 MCP Chrome PASS** · TG `[ ]` |
| PWA ЛК (#69) | **Витрина / PWA** — hub ЛК: история заказов, детали, настройки, «О нас», bottom sheet поддержки | [ТЗ](customer_tasks/Доработка%20личного%20кабинета%20(ЛК)%20в%20PWA.md) · [`artifacts/pwa_personal_account_lk/`](../artifacts/pwa_personal_account_lk/) | **local regress PASS** 2026-08-26 · REVIEW/CI · deploy апрув |
| Telegram bot support ЛК (#70) | **Витрина / PWA** — deep link `@code_black_support_bot` из шапки ЛК и «Написать нам»; без context/iframe/email | [ТЗ](customer_tasks/Связь%20через%20Telegram-бота%20поддержки%20в%20ЛК.md) · [`artifacts/telegram_bot_support_lk/`](../artifacts/telegram_bot_support_lk/) | **CI green** 2026-08-26 · deploy апрув · Fly MCP |
| Email after pay Callcheck (#71) | **Витрина / PWA** — Патч_1: post-pay → `MobileCustomer.email` + server prefill; review: no unverified squat | [ТЗ](customer_tasks/Email-сбор%20после%20оплаты%20(Callcheck-флоу).md) § Патч_1 · [`artifacts/email_collection_after_payment/`](../artifacts/email_collection_after_payment/) | **REVIEW** 2026-09-17 · push/CI · Fly MCP после deploy |
| Receipt.Email / Phone для фискальных чеков (#72) | **Эквайринг / ОФД** — передача контакта покупателя в Receipt (Init/Confirm/Cancel/SendClosingReceipt); приоритет Email над Phone; без своей почтовой отправки чека | [ТЗ](customer_tasks/Доработка%20бэкенда%20—%20передача%20email%20покупателя%20в%20Receipt%20для%20фискальных%20чеков.md) · [`artifacts/receipt_email_fiscal_checks/`](../artifacts/receipt_email_fiscal_checks/) | **REVIEW** 2026-08-27 · CI · deploy апрув · Fly MCP |
| Fiscal receipts в ЛК (#73) | **Эквайринг / ОФД / PWA** — входящие уведомления фискализации «Чеки Т-Бизнес»: хранение, идемпотентность, секция «Чек» в истории заказов ЛК; без своего QR и API запроса чека | [ТЗ](customer_tasks/Хранение%20и%20отображение%20фискальных%20чеков%20в%20личном%20кабинете.md) · [`artifacts/fiscal_receipts_personal_cabinet/`](../artifacts/fiscal_receipts_personal_cabinet/) | **REVIEW** 2026-08-27 · CI · deploy апрув · Fly MCP |
| Card binding unique hash (#74) | **Security / платежи** — одна карта → один аккаунт: `card_hash`, unique active constraint, нейтральный отказ без утечки `card_masked`/BIN/банка; race на уровне БД | [ТЗ](customer_tasks/Устранение%20утечки%20данных%20чужой%20карты%20при%20привязке.md) · [`artifacts/card_binding_unique_hash/`](../artifacts/card_binding_unique_hash/) | **/regress PASS** 2026-08-27 · ждёт `/review` |
| Payment method binding + promo 11₽ (#75) | **Эквайринг / PWA** — единая привязка card+СБП (`method_hash`/`method_type`), antifraud/velocity, промо 11₽ growth event, UI тексты/nudge; без новых внешних endpoint | [ТЗ](customer_tasks/Привязка%20способа%20оплаты%20и%20промо%2011₽.md) · [`artifacts/payment_method_binding_promo_11rub/`](../artifacts/payment_method_binding_promo_11rub/) | **REVIEW + follow-up `[x]`** 2026-09-04 · CI/deploy апрув |
| УК point campaign promo 11₽ (#76) | **УК / point-level** — `point_campaign_settings` (`card_binding_promo`): вкл. промо 11₽ при создании/редактировании точки, threshold/counter, без наследования между точками; без подписки | [ТЗ](customer_tasks/УК%20—%20включение%20промо%2011₽%20при%20создании%20точки.md) · [`artifacts/uk_point_campaign_promo_11rub/`](../artifacts/uk_point_campaign_promo_11rub/) | **SPEC `[x]`** 2026-09-04 · `/sbr` pending |
| Subscription offer eligibility (#77) | **Витрина / УК** — сигналы толерантности (`pwa`/`push`/`email`) + `SubscriptionOfferEligibility` + point-scoped `subscription_offer_settings` + CTA на `ready`; без billing/Tbank/фискализации | [ТЗ](customer_tasks/Умный%20показ%20оффера%20подписки%20—%20сигналы%20толерантности%20и%20УК-переключатель.md) · [`artifacts/subscription_offer_eligibility/`](../artifacts/subscription_offer_eligibility/) | **SPEC `[x]`** 2026-09-04 · `/sbr` pending |
| Архитектура подписки (#78) | **Витрина / Payments** — `subscription_plans` / `subscriptions` / usage events; покупка + merchant-initiated renewal через `TbankAdapter`; past_due/3DS; Shop API + PWA экраны; без дубля Init/Charge и без auto-Refund | [ТЗ](customer_tasks/Архитектура%20подписки%20—%20планы%20биллинг%20и%20автосписание.md) · [`artifacts/subscription_billing_architecture/`](../artifacts/subscription_billing_architecture/) | **REVIEW slice-1** 2026-09-05 · CI · backlog slices 2–7 |
| SBP return + autopay labels (#79) | **Эквайринг / PWA** — остаток CODE:BLACK: надписи статусов автоплатежа; оплаты 11/8 СБП; «через сколько дней»; recovery-экран → **split #86**; SMS → каскад отдельно | [ТЗ](customer_tasks/Надписи%20автоплатежа%20и%20экран%20после%20возврата%20из%20банка%20СБП.md) · [`artifacts/sbp_return_status_screen_autopay_labels/`](../artifacts/sbp_return_status_screen_autopay_labels/) | **parked** · recovery → #86 · 2026-09-15 |
| SBP PWA recovery after bank (#86) | **Эквайринг / PWA** — EXT CODE:BLACK: восстановление payment state после СБП/банка (return + cold start); device E2E Android+iOS; без SMS/каскада | [ТЗ](customer_tasks/TASK-86-Восстановление%20PWA%20после%20оплаты%20СБП-EXT.md) · [`artifacts/sbp_pwa_recovery_after_bank_ext/`](../artifacts/sbp_pwa_recovery_after_bank_ext/) · [Google Doc](https://docs.google.com/document/d/1i12UGabEH3UJQrR9y7tQS9ONZMvOxG_ARCg3bKcdDoU/edit?usp=drivesdk) | **SPEC `[x]`** 2026-09-15 · ждёт `/sbr` |
| Notifications / Wallet / WebPush gaps (#81) | **Витрина / PWA** — reopen #37/#38/#41: denied→настройки браузера; фоновые FCM/Wallet «не реализовано»; кнопка чат поддержки показывается, не работает | [ТЗ](customer_tasks/Косяки%20уведомлений%20Wallet%20WebPush%20фоновые%20и%20кнопка%20чат.md) · [`artifacts/notifications_wallet_webpush_gaps_reopen/`](../artifacts/notifications_wallet_webpush_gaps_reopen/) · скрин `01_push_denied_…` | **SPEC `[x]`** 2026-09-07 · `/sbr` pending · #38 backlog |
| Registration UI/UX + Callcheck cascade (#80) | **Витрина / PWA** — п.8: клавиатура/сумма заказа на вводе телефона; копирайт Callcheck; нет перехода в PWA после звонка; каскад Callcheck×2→SMS (док; сверка с каноном Callcheck vs flash_call в чек-листе) | [ТЗ](customer_tasks/Регистрация%20PWA%20UI%20UX%20и%20каскад%20Callcheck%20x2%20SMS.md) · [`artifacts/registration_callcheck_cascade_ui_ux/`](../artifacts/registration_callcheck_cascade_ui_ux/) | **REVIEW** CI green 2026-09-07 · deploy апрув · Fly MCP |
| TASK_89 PWA auth Callcheck → SMS (#89) | **Витрина / PWA** — Callcheck→SMS (не FlashCall); linker/session; после звонка переход в checkout + экран оплаты | [ТЗ](customer_tasks/TASK-89-Авторизация-регистрация-PWA-Callcheck-SMS.md) · [`artifacts/pwa_auth_registration_callcheck_sms/`](../artifacts/pwa_auth_registration_callcheck_sms/) · [Google Doc](https://docs.google.com/document/d/1wDRuIFxAl1pBSxh305sEidRxj-Kd6vwjytFkOvWn2ZQ/edit?usp=drivesdk) | **REVIEW** 2026-09-16 · push/CI · G5 Fly после deploy |
| TASK_89-UI-EXT phone input UI/UX | **Витрина / PWA** — EXT TASK_89: на phone-auth скрыть CTA суммы + состав корзины; тоньше checkout-sheet; без Callcheck/SMS/backend | [ТЗ](customer_tasks/TASK-89-UI-EXT-UI-UX-авторизации-PWA-экран-ввода-телефона.md) · [`artifacts/pwa_auth_phone_input_ui_ux/`](../artifacts/pwa_auth_phone_input_ui_ux/) · [Google Doc](https://docs.google.com/document/d/1PTP5LIVgnj2QNpOMi4Md4Lb8Y8imvL3MQnsHhVNDQoc/edit?usp=drivesdk) | **REVIEW** 2026-09-16 · push/CI · G5 Fly после deploy |
| TASK_89-POSTCALL-EXT return → continue payment | **Витрина / PWA** — EXT TASK_89: возврат из телефона в PWA после Callcheck; resume polling; инструкция «вернитесь»; авто PaymentMethodsSheet; без UI-EXT / без смены backend | [ТЗ](customer_tasks/TASK-89-POSTCALL-EXT-Возврат%20в%20PWA%20после%20Callcheck%20и%20продолжение%20оплаты.md) · [`artifacts/pwa_callcheck_return_continue_payment/`](../artifacts/pwa_callcheck_return_continue_payment/) · [Google Doc](https://docs.google.com/document/d/1w2VKMPaYZdsJcqNkLrpSbJBPuLE-7Sm9giQ8DcJ0Bq0/edit?usp=drivesdk) | **REVIEW** 2026-09-16 · push/CI · G5 Fly после deploy |
| TASK_90 WebPush recovery after denied (#90) | **Витрина / PWA** — EXT #81 п.9.1: recovery UI после `denied`; deep-link/fallback в настройки сайта; «Смотреть готовность»; без backend/SW/iOS/Wallet | [ТЗ](customer_tasks/TASK-90-Восстановление-WebPush-после-запрета-уведомлений.md) · [`artifacts/webpush_recovery_after_denied/`](../artifacts/webpush_recovery_after_denied/) · [Google Doc](https://docs.google.com/document/d/1YtZzj-Lf2HHrM4azejIuZISTKsWdu8q6y-kPHvm_d44/edit?usp=drivesdk) | **REVIEW** 2026-09-17 · push/CI · G5 Fly после deploy |
| TASK_91 post-pay auto return → catalog (#91) | **Витрина / PWA** — п.9.2: после email submit/Skip на payment-result авто `#/`; без немедленного redirect; без Checkout/SBP/статусной модели | [ТЗ](customer_tasks/TASK-91-Автоматический-возврат-на-каталог-после-post-pay-email.md) · [`artifacts/post_pay_auto_return_catalog_status/`](../artifacts/post_pay_auto_return_catalog_status/) · [Google Doc](https://docs.google.com/document/d/1nlWXyWV0UcV5X33i0owZixXRJl5d-nF_HwHdjjBVd2o/edit) | **REVIEW** 2026-09-17 · push/CI · G4 Fly после deploy |
| TASK_92 Production background FCM + status sync (#92) | **Витрина / PWA** — п.1 фоновые FCM/прогресс не реализованы; чат поддержки показывается, не кликается; reopen #38/#81 | [ТЗ](customer_tasks/TASK-92-Production-background-FCM-и-синхронизация-статусов-заказа.md) · [`artifacts/production_background_fcm_status_sync/`](../artifacts/production_background_fcm_status_sync/) · [Google Doc](https://docs.google.com/document/d/1gcML9WkV4n2s6KNsDN0sobY3ITm4Dge9kOjStzf917g/edit?usp=sharing) | **REVIEW** 2026-09-17 · push/CI · G5 Fly после deploy |
| TASK_93 Critical path hardening (#93) | **Деньги / витрина / ops** — зонтик A–L; **B** REVIEW phone-first Checkout identity | [зонтик](customer_tasks/TASK-93-Critical-path-hardening.md) · [B](customer_tasks/TASK-93-B-Checkout-identity.md) · [GATES B](../artifacts/critical_path_hardening/GATES-block-B.md) | **REVIEW B** 2026-09-18 · push/CI · deploy = L |
| TASK_94 LK history repeat one-click (#94) | **Витрина / ЛК** — доп.задача к PERSONAL-CABINET: «Повторить» из истории → новый Order + существующий Quick Repeat one-click; без checkout/payment API | [ТЗ](customer_tasks/TASK-94-Повтор-покупки-из-истории-ЛК-с-one-click-оплатой.md) · [`artifacts/lk_history_repeat_one_click/`](../artifacts/lk_history_repeat_one_click/) · [Google Doc](https://docs.google.com/document/d/19QWNuRirU9jGkzFMY7sXXQV8xFTf2oEq_u3Yf0fo-6w/edit) | **REVIEW** 2026-09-19 · push/CI · Fly MCP G5 после deploy |
| Cascade SMS ready + status sheet stuck (#82) | **Витрина / уведомления + PWA** — п.10: SMS-каскад после `ready` не работает (reopen #39); статусная модель не скрывается на гл. экране после «готов» на табло (reopen #35/#63) | [ТЗ](customer_tasks/Каскад%20SMS%20после%20Заказ%20готов%20и%20шторка%20статуса%20на%20главном.md) · [`artifacts/order_ready_cascade_sms_status_sheet_fix/`](../artifacts/order_ready_cascade_sms_status_sheet_fix/) | **SPEC `[x]`** 2026-09-07 · `/sbr` pending |
| Status sheet dismiss (×) (#83) | **Витрина / PWA** — поведение крестика (local dismiss) в статусной шторке; без API; без чека/Cable; продуктовые решения Cable/reload до RED | [ТЗ](customer_tasks/TASK-83-status-sheet-dismiss.md) · [`artifacts/status_sheet_dismiss_behavior/`](../artifacts/status_sheet_dismiss_behavior/) | **REVIEW** CI green 2026-09-13 · deploy апрув |
| Status sheet receipt restore (#84) | **Витрина / PWA** — вернуть состав чека + CTA «Состав заказа» в статусную шторку; reverse QA `7ab3f3e6`; без dismiss/`orderStatusSheet` | [ТЗ](customer_tasks/TASK-84-status-sheet-receipt-restore.md) · [`artifacts/status_sheet_receipt_restore/`](../artifacts/status_sheet_receipt_restore/) | **REVIEW** CI green 2026-09-13 · deploy апрув |
| TASK_84-RECEIPT-DISPLAY-EXT runtime receipt | **Витрина / PWA** — EXT #84: фактическое отображение текстового чека в `ActiveOrdersAccordion`; runtime-тест DOM; без backend/`receiptView` rewrite | [ТЗ](customer_tasks/TASK-84-RECEIPT-DISPLAY-EXT-Восстановление-фактического-отображения-состава-чека-в-ActiveOrdersAccordion.md) · [`artifacts/active_orders_receipt_display_restore/`](../artifacts/active_orders_receipt_display_restore/) · [Google Doc](https://docs.google.com/document/d/13Msfo8hDhUXHHB3NoKhMQvrPxQMpvlKctvFDOkr7aEI/edit) | **REVIEW** 2026-09-21 · push/CI · G5 Fly после deploy |
| Quick Repeat status composition (#87) | **Витрина / PWA** — Quick Repeat one-click → Order в status model + состав; правка 7.1: после card autopay не показывать интерактивный блок корзины | [ТЗ](customer_tasks/TASK-87-Quick-Repeat-status-model-composition.md) · [`artifacts/quick_repeat_status_model_composition/`](../artifacts/quick_repeat_status_model_composition/) · [Google Doc](https://docs.google.com/document/d/1sdkJYZzLgVKiUTWfZuKDkL8kSuBPRNFSRiEFDQsxGbo/edit?usp=drivesdk) | **REVIEW** 2026-09-15 · push/CI · Fly MCP G4 после deploy |
...
| Order action buttons status panel | **Витрина / PWA** — динамический блок CTA справа от progress bar (Отмена / Чат / Чаевые / Push|Wallet) по матрице статусов + WS | [ТЗ](customer_tasks/Динамический%20блок%20действий%20Action%20Buttons%20в%20статусной%20панели%20заказа.md) · [`artifacts/order_action_buttons_status_panel/`](../artifacts/order_action_buttons_status_panel/) | **закрыта `[x]`** 2026-08-05 · Fly **v431** · **reopen gap #81** (чат поддержки не кликается) |
...
| Product card peek cart | **Витрина / PWA** — на карточке товара видеть набранные позиции; peek: ±1 + horizontal scroll; CTA «добавить к заказу»; одна шторка без наложений | [ТЗ](customer_tasks/Карточка%20товара%20отображение%20набранных%20позиций%20и%20функциональность%20в%20режиме%20peek.md) · [`artifacts/product_card_peek_cart/`](../artifacts/product_card_peek_cart/) | **Fly v436 MCP PASS** 2026-08-06 · апрув `[ ]` |
| PWA status sync + repeats stale | **Витрина / PWA** — статусы с табло баристы не едут без reload; после заказа «повторы»/история не подгружаются (пустая шторка +0₽) | [ТЗ](customer_tasks/Статусы%20с%20табло%20не%20подтягиваются%20в%20PWA%20и%20повторы%20после%20заказа.md) · [`artifacts/pwa_status_sync_and_repeats_stale/`](../artifacts/pwa_status_sync_and_repeats_stale/) | **MCP PASS `[x]`** Fly v443 · апрув `[ ]` |
| SMS.ru API sms/send | **Интеграции / SMS.ru** — `sms/send`: SendResult/`sms_id`, per-phone ERROR, cascade payload | [ТЗ](customer_tasks/SMS.ru%20API%20Отправить%20СМС%20HTTP%20запросом.md) · [`artifacts/sms_ru_api_send_http/`](../artifacts/sms_ru_api_send_http/) | **GREEN+REVIEW `[x]`** 2026-08-11 · апрув `[ ]` |
...
| 26 | **Repeat order invalid token payment sheet** | QA step5 inline при отказе банка | **REVIEW** 2026-09-06 · CI GREEN · MCP `[ ]` · апрув `[ ]` | [Главный экран — повторный заказ…](customer_tasks/Главный%20экран%20—%20повторный%20заказ%20(невалидный%20токен)%20BottomSheet%20выбора%20способа%20оплаты.md) |
...
| 33 | **T-Kassa Widget One-Click + Fallback** | Виджет Т-Кассы SDK (connection_type: Widget) + One-Click + fallback СБП/карта при отказе | **Fly v440 MCP PASS** 2026-08-07 · апрув `[ ]` | [Интеграция виджета быстрой оплаты…](customer_tasks/Интеграция%20виджета%20быстрой%20оплаты%20Т-Кассы%20и%20One-Click%20сценария%20в%20PWA.md) |
...
| 35 | **Order status compact sheet + Push** | Виджет только accepted/paid/preparing; hide on ready; home + product; Push ready | **Fly v438 MCP PASS** 2026-08-06 · апрув `[ ]` | [Интеграция статусной модели…](customer_tasks/Интеграция%20статусной%20модели%20в%20компактную%20шторку%20PWA%20и%20Push.md) |
...
| 46 | **Bank auth limit blocks payment** | Сбой банка: «Превышено допустимое количество запросов авторизации» → нельзя оплатить / сменить статусы; СБП | **MCP PASS `[x]`** Fly v441 · апрув `[ ]` | [Сбой банка не могу оплатить…](customer_tasks/Сбой%20банка%20не%20могу%20оплатить%20заказ%20для%20статусов.md) · [artifacts](../artifacts/bank_auth_limit_blocks_payment/) · [mcp/fly_v441](../artifacts/bank_auth_limit_blocks_payment/mcp/fly_v441_2026-08-07/) |
| 47 | **PWA status sync + repeats stale** | Статусы с табло не в PWA без reload; после заказа повторы/история не подгружаются | **MCP PASS `[x]`** Fly v443 · апрув `[ ]` | [Статусы с табло не подтягиваются…](customer_tasks/Статусы%20с%20табло%20не%20подтягиваются%20в%20PWA%20и%20повторы%20после%20заказа.md) · [artifacts](../artifacts/pwa_status_sync_and_repeats_stale/) · [mcp/fly_v443](../artifacts/pwa_status_sync_and_repeats_stale/mcp/fly_v443_2026-08-08/) |
| 48 | **SMS.ru API sms/send** | `SendResult`/`sms_id`, per-phone ERROR, cascade payload | **GREEN+REVIEW `[x]`** 2026-08-11 · апрув `[ ]` | [SMS.ru API Отправить СМС HTTP…](customer_tasks/SMS.ru%20API%20Отправить%20СМС%20HTTP%20запросом.md) · [artifacts](../artifacts/sms_ru_api_send_http/) |
...
| 62 | **SBP autopay checkbox default checked** | Доп к #34: чекбокс привязки СБП checked по умолчанию; uncheck → `save_sbp_account=false`; без сброса после UI-redraw; backend не трогаем | **GREEN local** 2026-08-13 · MCP `[ ]` · апрув `[ ]` | [Предустановленный чекбокс автоплатежа СБП](customer_tasks/Предустановленный%20чекбокс%20автоплатежа%20СБП.md) · [artifacts](../artifacts/sbp_autopay_checkbox_default_checked/) |
| 63 | **Svelte 5 status widget reactivity UX** | Доп к #35: иммутабельный applyCableEvent/sync; `userDismissed` + X; скрытие виджета на `#/product` / `#/profile` / pay; Cable живёт после dismiss | **Fly v454 MCP PASS** 2026-08-13 · апрув `[ ]` | [Исправление реактивности Svelte 5…](customer_tasks/Исправление%20реактивности%20Svelte%205%20и%20UX%20управления%20статусным%20виджетом.md) · [artifacts](../artifacts/svelte5_status_widget_reactivity_ux/) · [mcp/fly_v454](../artifacts/svelte5_status_widget_reactivity_ux/mcp/fly_v454_2026-08-13/) |
| 64 | **Shop Telegram/Instagram in-app open** | `/shop?tenant_id=` во встроенных браузерах Telegram/Instagram Android+iOS; без вечного skeleton; фикс только по доказанной точке отказа | **Fly v456 MCP Chrome PASS** · TG/IG `[ ]` | [Исправление открытия shop…](customer_tasks/Исправление%20открытия%20shop%20во%20встроенных%20браузерах%20Telegram%20и%20Instagram.md) · [artifacts](../artifacts/shop_telegram_instagram_inapp_browser/) |
| 65 | **Telegram/Instagram In-App → /shop linkage** | Связка TG/IG In-App → `/shop` + categories API; tenant_id integrity; error/cache fallback; без auth через UA/TG; без forced redirect | **Fly v456 MCP Chrome PASS** · TG/IG `[ ]` | [Изменения в связке Telegram Instagram…](customer_tasks/Изменения%20в%20связке%20Telegram%20Instagram%20In-App%20Browser%20к%20CoffeeOS%20shop.md) · [artifacts](../artifacts/telegram_instagram_inapp_shop_linkage/) |
| 66 | **Telegram WebView storefront runtime** | Полноценная работа мобильной витрины внутри Telegram In-App Browser: JS/Svelte/API/CORS/CSP/cookies/storage/tenant/nav/viewport; без bot/payments | **Fly v456 MCP Chrome PASS** · TG `[ ]` | [Полноценная работа мобильной витрины…](customer_tasks/Полноценная%20работа%20мобильной%20витрины%20CoffeeOS%20внутри%20Telegram%20In-App%20Browser.md) · [artifacts](../artifacts/mobile_storefront_telegram_webview/) |
| 67 | **Telegram WebView mobile UI** | Адаптация Mobile UI витрины под Telegram WebView: visual viewport / sticky / CartSheet / safe-area / keyboard; без backend, bot, повторного #66 runtime | **Fly v456 MCP PARTIAL** (S7 SKIP) · TG `[ ]` | [Адаптация Mobile UI витрины…](customer_tasks/Адаптация%20Mobile%20UI%20витрины%20CoffeeOS%20под%20Telegram%20WebView.md) · [artifacts](../artifacts/mobile_storefront_telegram_webview_ui/) |
| 68 | **Telegram WebView UX / Performance** | UX+perf витрины в Telegram WebView: skeleton, SWR cache по tenant, lazy images, retry/offline, network vs HTTP; без backend, bot, #66 runtime, #67 layout | **Fly v456 MCP Chrome PASS** · TG `[ ]` | [UX и Performance мобильной витрины…](customer_tasks/UX%20и%20Performance%20мобильной%20витрины%20CoffeeOS%20внутри%20Telegram%20WebView.md) · [artifacts](../artifacts/mobile_storefront_telegram_webview_ux_perf/) |
| 69 | **PWA ЛК** | Доработка личного кабинета: hub с историей, детали заказа, настройки/контакты, «О нас», поддержка; без ОФД/PLG/subscription | **local regress PASS** 2026-08-26 · REVIEW/CI · deploy апрув | [Доработка личного кабинета (ЛК) в PWA.md](customer_tasks/Доработка%20личного%20кабинета%20(ЛК)%20в%20PWA.md) · [artifacts](../artifacts/pwa_personal_account_lk/) |
| 70 | **Telegram bot support ЛК** | Deep link `https://t.me/code_black_support_bot` из иконки чата ЛК и «Написать нам»; один URL; без user/order params, iframe, email-логики | **CI green** 2026-08-26 · deploy апрув · Fly MCP | [Связь через Telegram-бота поддержки в ЛК.md](customer_tasks/Связь%20через%20Telegram-бота%20поддержки%20в%20ЛК.md) · [artifacts](../artifacts/telegram_bot_support_lk/) |
| 80 | **Registration UI/UX + Callcheck cascade** | П.8 регистрация: сумма над клавиатурой; копирайт Callcheck; нет перехода после звонка; каскад Callcheck×2→SMS (сверка API) | **SPEC `[x]`** 2026-09-07 · `/sbr` pending | [Регистрация PWA UI UX…](customer_tasks/Регистрация%20PWA%20UI%20UX%20и%20каскад%20Callcheck%20x2%20SMS.md) · [artifacts](../artifacts/registration_callcheck_cascade_ui_ux/) |
| 81 | **Notifications / Wallet / WebPush gaps** | Reopen #37/#38/#41: denied→settings браузера; фоновые FCM/Wallet; чат поддержки не кликается | **SPEC `[x]`** 2026-09-07 · `/sbr` · #38 backlog | [Косяки уведомлений…](customer_tasks/Косяки%20уведомлений%20Wallet%20WebPush%20фоновые%20и%20кнопка%20чат.md) · [artifacts](../artifacts/notifications_wallet_webpush_gaps_reopen/) |
| 82 | **Cascade SMS ready + status sheet stuck** | П.10: SMS после «заказ готов» не работает (reopen #39); шторка статуса остаётся на гл. экране после «готов» на табло (reopen #35/#63) | **SPEC `[x]`** 2026-09-07 · `/sbr` pending | [Каскад SMS после Заказ готов…](customer_tasks/Каскад%20SMS%20после%20Заказ%20готов%20и%20шторка%20статуса%20на%20главном.md) · [artifacts](../artifacts/order_ready_cascade_sms_status_sheet_fix/) |
| 83 | **Status sheet dismiss (×)** | Локальный dismiss крестиком в статусной шторке; scope `aoa__dismiss` + `dismissOrder`/`refreshMode`; без чека/Cable/API; Cable/reload — продуктовые решения до RED | **REVIEW** CI green 2026-09-13 · deploy апрув | [TASK-83-status-sheet-dismiss.md](customer_tasks/TASK-83-status-sheet-dismiss.md) · [artifacts](../artifacts/status_sheet_dismiss_behavior/) |
| 84 | **Status sheet receipt restore** | Вернуть состав чека + CTA «Состав заказа» в шторку; `receiptView` / `openOrderReceipt`; без `aoa__dismiss` / `orderStatusSheet` | **REVIEW** CI green 2026-09-13 · deploy апрув | [TASK-84-status-sheet-receipt-restore.md](customer_tasks/TASK-84-status-sheet-receipt-restore.md) · [artifacts](../artifacts/status_sheet_receipt_restore/) |
| 84-RECEIPT-DISPLAY-EXT | **TASK_84-RECEIPT-DISPLAY-EXT** runtime receipt display | EXT #84: фактический показ текстового чека в `ActiveOrdersAccordion` + runtime DOM-тест; без backend/`receiptView` rewrite | **REVIEW** 2026-09-21 · push/CI · G5 Fly после deploy | [TASK-84-RECEIPT-DISPLAY-EXT-…](customer_tasks/TASK-84-RECEIPT-DISPLAY-EXT-Восстановление-фактического-отображения-состава-чека-в-ActiveOrdersAccordion.md) · [artifacts](../artifacts/active_orders_receipt_display_restore/) |
| 86 | **SBP PWA recovery after bank** | Восстановление PWA после СБП/банка (return + cold start); device Android+iOS; без SMS/каскада; без надписей автоплатежа (#79) | **SPEC `[x]`** 2026-09-15 · ждёт `/sbr` | [TASK-86-…](customer_tasks/TASK-86-Восстановление%20PWA%20после%20оплаты%20СБП-EXT.md) · [artifacts](../artifacts/sbp_pwa_recovery_after_bank_ext/) |
| 87 | **Quick Repeat status composition** | Quick Repeat one-click → Order в status model + состав; 7.1 после card autopay убрать интерактивный блок корзины | **REVIEW** 2026-09-15 · push/CI · Fly MCP G4 после deploy | [TASK-87-…](customer_tasks/TASK-87-Quick-Repeat-status-model-composition.md) · [artifacts](../artifacts/quick_repeat_status_model_composition/) |
| 89 | **TASK_89** PWA auth Callcheck → SMS | Callcheck→SMS; linker/session; post-call → PWA checkout + экран оплаты; overlap #80 UI | **REVIEW** 2026-09-16 · push/CI · G5 Fly после deploy | [TASK-89-…](customer_tasks/TASK-89-Авторизация-регистрация-PWA-Callcheck-SMS.md) · [artifacts](../artifacts/pwa_auth_registration_callcheck_sms/) |
| 89-UI-EXT | **TASK_89-UI-EXT** phone input UI/UX | EXT TASK_89: phone-auth — скрыть CTA суммы + cart preview; тоньше sheet; без Callcheck/SMS | **REVIEW** 2026-09-16 · push/CI · G5 Fly после deploy | [TASK-89-UI-EXT-…](customer_tasks/TASK-89-UI-EXT-UI-UX-авторизации-PWA-экран-ввода-телефона.md) · [artifacts](../artifacts/pwa_auth_phone_input_ui_ux/) |
| 89-POSTCALL-EXT | **TASK_89-POSTCALL-EXT** return → continue payment | EXT TASK_89: return из телефона → resume Callcheck → auth → PaymentMethodsSheet; без UI-EXT / backend | **REVIEW** 2026-09-16 · push/CI · G5 Fly после deploy | [TASK-89-POSTCALL-EXT-…](customer_tasks/TASK-89-POSTCALL-EXT-Возврат%20в%20PWA%20после%20Callcheck%20и%20продолжение%20оплаты.md) · [artifacts](../artifacts/pwa_callcheck_return_continue_payment/) |
| 90 | **TASK_90** WebPush recovery after denied | EXT #81 п.9.1: recovery UI + deep-link/fallback `denied → settings`; без backend/SW/iOS | **REVIEW** 2026-09-17 · push/CI · G5 Fly после deploy | [TASK-90-…](customer_tasks/TASK-90-Восстановление-WebPush-после-запрета-уведомлений.md) · [artifacts](../artifacts/webpush_recovery_after_denied/) |
| 91 | **TASK_91** post-pay auto return → catalog + status | п.9.2: после email/Skip на payment-result → авто `#/` + существующая статусная модель; защита #71 no immediate redirect | **REVIEW** 2026-09-17 · push/CI · G4 Fly после deploy | [TASK-91-…](customer_tasks/TASK-91-Автоматический-возврат-на-каталог-после-post-pay-email.md) · [artifacts](../artifacts/post_pay_auto_return_catalog_status/) |
| 92 | **TASK_92** Production background FCM + status sync | п.1 фоновые FCM не реализованы; чат поддержки UI есть, клик нет; reopen #38/#81 | **REVIEW** 2026-09-17 · push/CI · G5 Fly после deploy | [TASK-92-…](customer_tasks/TASK-92-Production-background-FCM-и-синхронизация-статусов-заказа.md) · [artifacts](../artifacts/production_background_fcm_status_sync/) |
| 94 | **TASK_94** LK history repeat one-click | Доп.задача к ЛК: «Повторить» из истории → новый Order + существующий Quick Repeat/widget one-click; не патч stub Subtask 12; без checkout/payment API | **REVIEW** 2026-09-19 · push/CI · Fly MCP G5 после deploy | [TASK-94-…](customer_tasks/TASK-94-Повтор-покупки-из-истории-ЛК-с-one-click-оплатой.md) · [artifacts](../artifacts/lk_history_repeat_one_click/) |
