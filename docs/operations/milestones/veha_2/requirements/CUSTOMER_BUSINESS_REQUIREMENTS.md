...
| Telegram/Instagram In-App → /shop linkage | **Витрина** — связка перехода TG/IG In-App → `/shop` + `/shop/api/categories`; tenant_id без подмены; error/cache fallback; без auth через UA/TG identity | [ТЗ](customer_tasks/Изменения%20в%20связке%20Telegram%20Instagram%20In-App%20Browser%20к%20CoffeeOS%20shop.md) · [`artifacts/telegram_instagram_inapp_shop_linkage/`](../artifacts/telegram_instagram_inapp_shop_linkage/) | **SPEC** 2026-08-14 · RED `[ ]` |
...
| 65 | **Telegram/Instagram In-App → /shop linkage** | Связка TG/IG In-App → `/shop` + categories API; tenant_id integrity; error/cache fallback; без auth через UA/TG; без forced redirect | **SPEC** 2026-08-14 · RED `[ ]` | [Изменения в связке Telegram Instagram…](customer_tasks/Изменения%20в%20связке%20Telegram%20Instagram%20In-App%20Browser%20к%20CoffeeOS%20shop.md) · [artifacts](../artifacts/telegram_instagram_inapp_shop_linkage/) |
