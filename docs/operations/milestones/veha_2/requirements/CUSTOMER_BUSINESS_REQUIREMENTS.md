...
| Status sheet dismiss (×) (#83) | **Витрина / PWA** — поведение крестика (local dismiss) в статусной шторке; без API; без чека/Cable; продуктовые решения Cable/reload до RED | [ТЗ](customer_tasks/TASK-83-status-sheet-dismiss.md) · [`artifacts/status_sheet_dismiss_behavior/`](../artifacts/status_sheet_dismiss_behavior/) | **intake `[x]`** 2026-09-13 · ждёт `/spec` |
...
| 83 | **Status sheet dismiss (×)** | Локальный dismiss крестиком в статусной шторке; scope `aoa__dismiss` + `dismissOrder`/`refreshMode`; без чека/Cable/API; Cable/reload — продуктовые решения до RED | **intake `[x]`** 2026-09-13 · ждёт `/spec` | [TASK-83-status-sheet-dismiss.md](customer_tasks/TASK-83-status-sheet-dismiss.md) · [artifacts](../artifacts/status_sheet_dismiss_behavior/) |
