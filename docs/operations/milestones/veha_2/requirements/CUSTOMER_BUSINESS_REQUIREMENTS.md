...
| 94 | **TASK_94** LK history repeat one-click | Доп.задача к ЛК: «Повторить» из истории → новый Order + существующий Quick Repeat/widget one-click; не патч stub Subtask 12; без checkout/payment API | **SPEC `[x]`** 2026-09-19 · ждёт `/sbr` | [TASK-94-…](customer_tasks/TASK-94-Повтор-покупки-из-истории-ЛК-с-one-click-оплатой.md) · [artifacts](../artifacts/lk_history_repeat_one_click/) |
