...
| Status sheet receipt restore (#84) | **Витрина / PWA** — вернуть состав чека + CTA «Состав заказа» в статусную шторку; reverse QA `7ab3f3e6`; без dismiss/`orderStatusSheet` | [ТЗ](customer_tasks/TASK-84-status-sheet-receipt-restore.md) · [`artifacts/status_sheet_receipt_restore/`](../artifacts/status_sheet_receipt_restore/) | **intake `[x]`** 2026-09-13 · ждёт `/spec` |
...
| 84 | **Status sheet receipt restore** | Вернуть состав чека + CTA «Состав заказа» в шторку; `receiptView` / `openOrderReceipt`; без `aoa__dismiss` / `orderStatusSheet` | **intake `[x]`** 2026-09-13 · ждёт `/spec` | [TASK-84-status-sheet-receipt-restore.md](customer_tasks/TASK-84-status-sheet-receipt-restore.md) · [artifacts](../artifacts/status_sheet_receipt_restore/) |
