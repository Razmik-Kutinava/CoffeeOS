...
| Active orders accordion + repeat | **Витрина / PWA** — expanded-аккордеон активных заказов (чек + «Повторить»), multi-order, стоп-лист | [ТЗ](customer_tasks/Мульти-статусная%20шторка%20активных%20заказов%20с%20повторной%20покупкой.md) · [`artifacts/active_orders_accordion_repeat/`](../artifacts/active_orders_accordion_repeat/) | **SPEC `[x]`** 2026-07-31 · RED `[ ]` ждёт go |
...
| 36 | **Active orders accordion + repeat** | Expanded-аккордеон активных заказов: чек, «Повторить», multi-order, стоп-лист | **SPEC `[x]`** 2026-07-31 · RED `[ ]` | [Мульти-статусная шторка…](customer_tasks/Мульти-статусная%20шторка%20активных%20заказов%20с%20повторной%20покупкой.md) |
