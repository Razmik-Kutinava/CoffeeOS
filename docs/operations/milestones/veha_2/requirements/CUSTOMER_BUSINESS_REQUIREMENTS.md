...
| Email after pay Callcheck (#71) | **Витрина / PWA** — QA reopen 2026-09-06: после сбора email для чека — **не спрашивать** на следующих заказах | [ТЗ](customer_tasks/Email-сбор%20после%20оплаты%20(Callcheck-флоу).md) · [`artifacts/email_collection_after_payment/`](../artifacts/email_collection_after_payment/) | **QA reopen** 2026-09-06 · SPEC `[ ]` · апрув `[ ]` |
