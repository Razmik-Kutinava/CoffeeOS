...
| 13 | **Bottom sheet expanded grid** | Expanded до 1-го ряда каталога + сетка товаров 4 в ряд со скроллом | **intake `[x]`** 2026-07-21 · SPEC / код `[ ]` | [Bottom Sheet expanded mode и внутренняя сетка 4 в ряд.md](customer_tasks/Bottom%20Sheet%20expanded%20mode%20и%20внутренняя%20сетка%204%20в%20ряд.md) |
