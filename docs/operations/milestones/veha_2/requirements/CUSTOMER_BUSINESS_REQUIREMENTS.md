...
| Bank auth limit blocks payment | **Эквайринг / PWA** — лимит авторизаций банка блокирует оплату (статусы не сменяются); СБП | [ТЗ](customer_tasks/Сбой%20банка%20не%20могу%20оплатить%20заказ%20для%20статусов.md) · [`artifacts/…`](../artifacts/bank_auth_limit_blocks_payment/) | **интейк `[x]`** 2026-08-07 · fix `[ ]` |
...
| 46 | **Bank auth limit blocks payment** | Сбой банка: «Превышено допустимое количество запросов авторизации» → нельзя оплатить / сменить статусы; СБП | **интейк `[x]`** 2026-08-07 · fix `[ ]` | [Сбой банка не могу оплатить…](customer_tasks/Сбой%20банка%20не%20могу%20оплатить%20заказ%20для%20статусов.md) · [artifacts](../artifacts/bank_auth_limit_blocks_payment/) |
