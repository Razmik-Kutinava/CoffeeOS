...
| 94 | **Production background FCM + status sync (TASK_92)** | п.1 фоновые FCM не реализованы; чат поддержки UI есть, клик нет; reopen #38/#81; CBR #92 ≠ этот TASK | **SPEC `[x]`** 2026-09-17 · ждёт `/sbr` | [TASK-92-…](customer_tasks/TASK-92-Production-background-FCM-и-синхронизация-статусов-заказа.md) · [artifacts](../artifacts/production_background_fcm_status_sync/) |
