...
|-------|--------|---------|
| **1 Приём** | Оплата §2.3, autorefresh меню, онбординг, **W1.1**, **W1.2 MCP меню** | W1.3–W1.4, уведомления, юр., kiosk |
...
| **Следующий шаг** | **W1.3** обяз. модификаторы → W1.4 сверка категорий → **блок 2** табло |
