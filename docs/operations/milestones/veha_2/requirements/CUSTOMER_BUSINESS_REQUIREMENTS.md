...
| B1.13 | **Новая навигация витрины** — S1: «Профиль › ID» в шапке, убрать «Профиль» из bottom nav | [ТЗ](customer_tasks/B1_13_shop_nav_profile_header.md) | **ТЗ S1** `[x]` 2026-06-22 · код `[ ]` · апрув + `go` `[ ]` |
...
| 10 | **B1.13** | Новая навигация витрины — S1: профиль в шапке | **ТЗ S1** `[x]` 2026-06-22 · код `[ ]` · апрув + `go` `[ ]` | [B1_13_shop_nav_profile_header.md](customer_tasks/B1_13_shop_nav_profile_header.md) |
...
|-------|--------|---------|
| **1 Приём** | Оплата §2.3, W1.1–W1.5, **B1.1**, **B1.7 checkout** | **B1.12** рекуррент · **B1.11** · **B1.13-S1** навигация · **B1.4 PWA** · B1.2–B1.3 |
