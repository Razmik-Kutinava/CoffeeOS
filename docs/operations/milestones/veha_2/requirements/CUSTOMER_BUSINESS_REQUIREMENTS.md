...
| B1.13 | **Новая навигация витрины** — эпик S1–S4 (шапка, поп-ап корзины, bottom bar) | [ТЗ](customer_tasks/B1_13_shop_nav_profile_header.md) | **ТЗ S1–S4** `[x]` 2026-06-22 · код `[ ]` · апрув + `go` `[ ]` |
...
| 10 | **B1.13** | Новая навигация витрины — S1–S4 (шапка + поп-ап корзины) | **ТЗ S1–S4** `[x]` 2026-06-22 · код `[ ]` · апрув + `go` `[ ]` | [B1_13_shop_nav_profile_header.md](customer_tasks/B1_13_shop_nav_profile_header.md) |

**Следующий фокус по задачам заказчика:** **B1.11** апрув · **B1.12** апрув эпика · **B1.13-S1** апрув + `go` · **B2.2** · **B1.4** `[ ]`.
...
|-------|--------|---------|
| **1 Приём** | Оплата §2.3, W1.1–W1.5, **B1.1**, **B1.7 checkout** | **B1.12** рекуррент · **B1.11** · **B1.13** эпик S1–S4 · **B1.4 PWA** · B1.2–B1.3 |
