# Offline-first и синхронизация (В2 — этап позже)

**Зачем документ:** зафиксировать scope **до кодирования** — POS barista при обрыве сети, очередь заказов, идемпотентность. **Чеклист:** [`CHECKLIST.md`](CHECKLIST.md) § G.

**Когда наполнять:** после закрытия приоритетов A–D (онбординг, оплата, киоск) или параллельно, если продукт сдвинет приоритет.
