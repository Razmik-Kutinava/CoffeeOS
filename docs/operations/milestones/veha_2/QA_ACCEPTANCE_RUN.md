...
| **7** | Staff/RBAC Prog10 ×9 (STF-01…05) | ✅ **2026-06-02** — curl 9/9 (`prog10_staff_isolation.json`); MCP UI **3/3 org** (`prog10_staff_mcp_3org.json`) — Demo/Alpha/Beta по 1 точке; STF-03 UI не гоняли |
