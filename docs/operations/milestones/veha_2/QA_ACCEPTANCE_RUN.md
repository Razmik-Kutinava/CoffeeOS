...
**Прогона 11 нет.** Добивка scope — **продолжение прогона 10** (блоки 1–14 ниже). См. [`SESSION_STATE.md`](../../SESSION_STATE.md) — точка входа для агента.
...
| **7** | Staff/RBAC Prog10 ×9 (STF-01…05) | ⚠ **2026-06-02** — curl 9/9; MCP **6/9** точек (`prog10_staff_mcp_6pt.json`): STF-01/02 ×6, **STF-03 создание staff ×6**, STF-04 новых barista ×6; prep + alpha-p3 + beta-p3 — только curl; **блок не закрыт** — ждём апрув |
