...
| # | Критерий | Статус |
|---|----------|--------|
| 3.1 | Один путь: **корзина → оформление → оплата → результат → история** | `[ ]` |
| 3.2 | **Назад** без потери корзины / заказа | `[ ]` |
| 3.3 | **Регистрация один раз:** имя + телефон запомнить (сессия/localStorage), второй заказ — меньше полей | `[ ]` |
| 3.4 | MCP: **второй заказ** тем же гостем на Fly | `[ ]` |
...
| **Следующий шаг агента** | **Этап 3** — экран оформления (один путь, назад, регистрация один раз) |
...
| Этап 2 §2.3 | **PASS** — [`mcp_section_2_3_stage2_2026-06-04.json`](artifacts/demo-feedback/mcp_section_2_3_stage2_2026-06-04.json), deploy `01KTC026K62C7QHT6JC3VRKNRS` |
