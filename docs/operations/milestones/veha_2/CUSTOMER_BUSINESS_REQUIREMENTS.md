...
**Долг — приёмка заказчиком (этап 4, UI оплаты):** см. **«Итог §2.3»** и **«Закрытие §2.3»** ниже — `[ ]` **ждём апрув**
...
| 5.3 | MCP + JSON → сводка §2.3, sync [`DEMO_FEEDBACK.md`](DEMO_FEEDBACK.md) | `[~]` **сводка готова** — ждём **апрув заказчика** |

> **2026-06-06 (5.3):** сводный MCP [`mcp_section_2_3_summary_2026-06-06.json`](artifacts/demo-feedback/mcp_section_2_3_summary_2026-06-06.json). **§2.3 целиком не закрываем** — см. «Закрытие §2.3» ниже.

**После этапа 5:** контент (фото, модификаторы в УК), ОФД/чек на почту, rebill карты — **отдельные пункты**, не блокируют закрытие §2.3.

---

## Итог §2.3 — что сделали (на апрув заказчика)

**Стенд:** https://coffeeos.fly.dev · **Deploy:** `01KTE2SYJK31BGHHRVWQ9AH9Z2` · **Точка A:** `?tenant_id=2fdee1ac-4674-41ee-b89e-87b45643f789`
...
1. **Посмотреть на Fly** экран оплаты: intro (сумма, «Картой»), маска жёлтых кнопок, iframe — скрин [`stage4_payment_shell_paying_2026-06-06.png`](artifacts/demo-feedback/screenshots/stage4_payment_shell_paying_2026-06-06.png).
2. **Ок / правки** по итоговой таблице выше.
3. После **вашего апрува** — закрываем §2.3 в чеклисте и переходим к блоку 2 (табло баристы).

**Сводный артефакт:** [`mcp_section_2_3_summary_2026-06-06.json`](artifacts/demo-feedback/mcp_section_2_3_summary_2026-06-06.json)
...
| Поле | Значение |
|------|----------|
| **Статус** | `[ ]` **открыто — ждём апрув заказчика** |
| Техэтапы 1–5 | Прогнаны (MCP + smoke + тест); детали в таблицах выше |
| Блокирует закрытие | Подпись заказчика по UI оплаты + итог §2.3 |
| После апрува | Поставить `[x]` здесь + обновить `DEMO_FEEDBACK` / `SESSION_STATE` |
...
| §2 | Витрина | **§2.3** — сводка готова, **ждём апрув** |
...
| Тема | Факт |
|------|------|
| **§2.3 закрытие** | **Открыто** — техпрогон PASS, ждём апрув заказчика ([`mcp_section_2_3_summary_2026-06-06.json`](artifacts/demo-feedback/mcp_section_2_3_summary_2026-06-06.json)) |
...
| Поле | Значение |
|------|----------|
| Версия | 2026-06-06, §2.3 сводка на апрув |
| **Следующий шаг** | **Апрув заказчика** по «Итог §2.3» → закрытие §2.3 → блок 2 |
| Сводка §2.3 | [`mcp_section_2_3_summary_2026-06-06.json`](artifacts/demo-feedback/mcp_section_2_3_summary_2026-06-06.json) |
| Закрытие §2.3 | `[ ]` открыто |
