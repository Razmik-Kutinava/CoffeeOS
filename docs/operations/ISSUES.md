...
| #93 TASK_93 Critical path hardening | 🟡 | **F** REVIEW Local 68/0 · bugbot+security PASS · Entire `01M2SSQXT1V67AK260SH1P9RAX` · push/CI · deploy=L · I parallel |
| EmailVerification tenant-wide DB | 🟡 | pre-existing: `verified_email` by tenant+email without session bind (TTL); security REVIEW TASK_93-B · not DoD B · backlog step-up |
