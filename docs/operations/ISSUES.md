...
| #93 Post-pay auto return → catalog (TASK_91) | 🟡 | **SPEC** 2026-09-17 · ждёт `/sbr` · gap `!askReceiptEmail` |
| #94 Production background FCM (TASK_92) | 🟡 | **intake** 2026-09-17 · ждёт `go` → `/spec` · reopen #38/#81 |
