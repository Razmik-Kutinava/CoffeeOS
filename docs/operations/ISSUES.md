...
| #93 Post-pay auto return → catalog (TASK_91) | 🟢 | **REVIEW** · push/CI · G4 Fly после deploy |
| #94 Production background FCM (TASK_92) | 🟡 | **GREEN** `f274c11c` · ждёт `/regress` · G5 Fly after deploy |
