...
| 2026-07-16 | **Checkout UX** stacked sheet (Фаза 2) | 🟡 код ✅ · G3 hide-status local · MCP после deploy | `fly deploy` под апрув → MCP pay-stack; → полная запись |
...
| 2026-08-08 | **#47** PWA статусы + повторы | 🟡 ready-in-sheet local ✅ · MCP v443 · апрув ❌ | deploy G3 + апрув заказчика; → полная запись |
