...
| 2026-07-31 | **Legacy shop suite** (~3–4 fail после triage) | 🟢 resolved | FakeTbankInit + CI full suite 2026-08-31; → полная запись |
| 2026-08-13 | **CI job `test`** / 4 legacy shop exclude | 🟢 resolved | exclude снят 2026-08-31; → полная запись |
...
| 2026-08-31 | **IB security debt** G-12 org guard · device cron · bundler-audit | 🟢 resolved | IB-D-01 + IB-D-02 **FIXED**; IB-D-03 open → [IB_SECURITY_DEBT.md](../product/security/IB_SECURITY_DEBT.md) |
