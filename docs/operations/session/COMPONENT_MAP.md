...
| Checkout | app/frontend/routes/Checkout.svelte | Маршрут #/checkout: корзина, phone wizard, handoff на оплату | → PhoneAuthWizard; PaymentMethodsSheet; cartSheetStore | #90, #89, #91 | После verify: `onWizardVerified` → `openPaymentSheet` (#89/#90); phone-auth slim sheet — #91 |
