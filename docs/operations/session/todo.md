...
- [ ] PHASE 2 RED — падающие тесты: copy «вернитесь»; visibility/pageshow ≠ init_callcheck; pending → «Проверяем номер» + poll; confirmed/SMS → openPaymentSheet
- [ ] PHASE 2 GREEN — resume poll + copy + handoff сохранён; зона PASS + `--reverify`
