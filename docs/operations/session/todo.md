...
**RESTART 2026-07-21** · код `7683dee` откачен (сетка была применена к шторке, владелец уточнил: сетка = каталог на главной, expanded-корзина остаётся строками) · ждём уточнённое ТЗ/решения → новое SPEC

Открытый вопрос владельцу: каталог сейчас — горизонтальные ленты карточек 8.5rem; «4 в ряд» на 414px = карточки ~93px. Подтвердить желаемый вид каталога до нового SPEC.
