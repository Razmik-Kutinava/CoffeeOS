...
**Фаза:** PHASE 0 `[x]` · SPEC `[x]` · шаги 1–5 GREEN `[x]` · RED шаг 6 `in_progress` · REVIEW `[ ]`  
**CBR:** #40
...
| 6 | Modal confirm для `accepted` (сумма) | `test/javascript/order_cancel_flow_test.mjs` (copy/format) | `OrderCancelModal.svelte` + flow lib | **RED** `[ ]` GREEN |
