...
**Фаза:** SPEC `[x]` · RED/GREEN шаги 1–3 `[x]` · RED шаг 4 `[x]` · GREEN 4–5 `[ ]` · REVIEW `[ ]` · MCP/deploy `[ ]`
...
| 4 | APNs update на смене статуса если pass есть; soft-fail; ReadyPushJob без double update | `guest_order_broadcaster.rb` · `ready_push_job.rb` | broadcaster + ready_push_job | **RED `[x]`** |
