...
| **B2.1 ревизия** | R0 docs `[x]` · 6 карточек + live `[ ]` | R1–R4 |
| **B2.1 MVP** | OPS_PASS 2026-06-11 · заменяется ревизией | — |

### Сессия 2026-06-12 (B2.1 ревизия — подготовка ТЗ)

- **Источник:** 2 баг-репорта заказчика — TO-DO vs 6 карточек; нет live без F5.
- **Доки:** `B2_1_barista_order_board.md` §Ревизия 2026-06-12, scope-таблица, чеклист R0–R4, бэклог.
- **Артефакт:** `b21_revision_stage0_scope_2026-06-12.json`, папка `b21_board_revision_2026-06-12/`.
- **Код:** не трогали — только R0.
