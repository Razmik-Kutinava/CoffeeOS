...
**Дата:** 2026-06-09 (ТЗ заказчика → `customer_tasks/`)  
**Предыдущее:** B1.7 checkout внутр. PASS; B1.1 уведомления — следующая задача  
...
- **Следующее:** прогон B1.7 заказчиком → реализация B1.1.
