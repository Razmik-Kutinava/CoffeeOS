...
**Дата:** 2026-06-30 (B1.13 docs S2-канон — устранение противоречий)  
...
| **B1.13 навигация** | § **S2-канон** выровнен в ops-доках · код prog18 MCP 20/20 | `go` prog19: UI/vh/testid · апрув · S4 |
