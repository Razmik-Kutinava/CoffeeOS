...
**Дата:** 2026-07-29 (PHASE 2 BUILD · Шаг 2 GREEN · T-Bank inline payment)

| Сейчас | Дальше |
|--------|--------|
| SPEC `[x]` · todo.md | **Шаг 2 GREEN** (Confirm+GetState) |
...
- `tbank_adapter.rb` >200 — GREEN: PayType O + inline Init сервис
