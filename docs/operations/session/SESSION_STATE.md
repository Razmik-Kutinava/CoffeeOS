...
**Предыдущее:** B1.11 этап 0 · B1.1 апрув `[x]` 2026-06-18 · B1.7 **ЗАКРЫТА**  
...
| Сейчас | Дальше |
|--------|--------|
| **B1.12 рекуррент / 1 клик** | этап 0 `[x]` · Q1,Q4,Q6 `[x]` · Q2,Q3,Q5,Q7 `[ ]` | ответы → апрув → `go` → R1 |
...
- **Ответы (2026-06-18):** Q1 только web · Q4 verified email как B1.7 · Q6 без макетов. Ждём Q2, Q3, Q5, Q7.
