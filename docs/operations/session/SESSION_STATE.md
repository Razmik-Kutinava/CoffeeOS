...
| Сейчас | Дальше |
|--------|--------|
| **B1.1 ревизия** | R0–R2 код `[x]` · R4 приёмка `[ ]` | апрув заказчика |
...
- **Не в прогоне:** доставка, табло/кухня, кнопка «Оплатить 3₽», Fly-скрины — бэклог в B1_1.
- **Тесты:** `order_status_acceptance_cbr_test`, `b21_guest_notify_test` — PASS.
