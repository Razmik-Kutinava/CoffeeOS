...
**Р”Р°С‚Р°:** 2026-07-01 (B1.13 docs: канон prog20 — убраны хвосты)  
**Р’РµС‚РєР°:** `develop`  
...
| **B1.13 rev2** | S2a/S2b/S3-rev2 · prog20 · MCP 22/22 | **`[x]` ЗАКРЫТ** апрув телефон 2026-07-01 |
| **Следующий шаг** | **`go` S4** (модификаторы · горизонтальный скролл в peek) | ждём `go` |
| **S4** | РїРѕСЃР»Рµ Р°РїСЂСѓРІР° S2 |
| **РђРіРµРЅС‚** | **СЃС‚РѕРї** |
