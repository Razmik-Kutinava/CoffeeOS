...
**Р”Р°С‚Р°:** 2026-06-30 (B1.13 prog20 — swap peek/expanded layouts)  
**Р’РµС‚РєР°:** `develop`  
...
| **S2-канон docs** | § **B1.13-S2-канон** выровнен | **код prog19** `[x]` |
| **S2a/S2b код** | prog20 · MCP **21/21** · expanded=vertical list | **апрув телефон** (build=prog20) |
