...
**Р”Р°С‚Р°:** 2026-06-30 (B1.13 docs S2-канон — устранение противоречий)  
**Р’РµС‚РєР°:** `develop`  
...
| **S2-канон docs** | § **B1.13-S2-канон** выровнен · prog9/prog15 помечены | **код prog19** |
| **S2a/S2b код** | prog18 · MCP **20/20** · build=prog18 | UI/vh ≠ канон → prog19 |
