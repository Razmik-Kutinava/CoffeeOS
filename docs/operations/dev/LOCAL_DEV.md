...
**Связано:** [`SHOP_URL_MODES.md`](SHOP_URL_MODES.md) (режим URL витрины), [`../milestones/veha_1/reference/DEMO_LOGINS.md`](../milestones/veha_1/reference/DEMO_LOGINS.md) (логины), [`../demo/FLY_DEMO_STAND.md`](../demo/FLY_DEMO_STAND.md) (прод на Fly).
...
Пароль demo-пользователей: **`demo123456`** — [`../milestones/veha_1/reference/DEMO_LOGINS.md`](../milestones/veha_1/reference/DEMO_LOGINS.md).
...
UUID из [`DEMO_LOGINS.md`](../milestones/veha_1/reference/DEMO_LOGINS.md) (колонка Fly) **не подставлять локально** — они другие.
