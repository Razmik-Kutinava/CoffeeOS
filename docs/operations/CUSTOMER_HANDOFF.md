...
**Сценарии:** [`milestones/veha_1/LIVE_DEMO_SCENARIOS_PLAIN.md`](milestones/veha_1/LIVE_DEMO_SCENARIOS_PLAIN.md) (§ 10 — минимум 4 истории)
...
| Полная таблица | [`milestones/veha_1/DEMO_LOGINS.md`](milestones/veha_1/DEMO_LOGINS.md) |
...
**Поддомены** `demo-point-a.coffeeos.fly.dev` на Fly **не используем** — см. [`SHOP_URL_MODES.md`](SHOP_URL_MODES.md).
...
- Ops: [`FLY_DEMO_STAND.md`](FLY_DEMO_STAND.md), [`HANDOFF.md`](HANDOFF.md)
