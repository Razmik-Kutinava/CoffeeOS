...
| Подписка guest PWA (`/shop/api/subscriptions/*`, #78) | [`shop-api.md`](shop-api.md) § Subscriptions |
| Telegram / Instagram In-App Browser → `/shop` | [`shop-api.md`](shop-api.md) § Embedded browser · WebView runtime · WebView UI · WebView UX/perf |
...
| Post-pay order email / CRM queue / email bounce (#71) | [`shop-api.md`](shop-api.md) § Orders · bounce HMAC `EMAIL_BOUNCE_WEBHOOK_SECRET` · CRM = **Brevo Contacts** (`Shop::CrmContactSync`, `BREVO_API_KEY`) |
...
*2026-08-11 · #61 webhooks · #60–#48 SMS.ru client …*
