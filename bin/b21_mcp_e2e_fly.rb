...
#   FLY_BIN=flyctl ruby bin/b21_mcp_e2e_fly.rb
...
Dir.chdir(ROOT) do
  run!("FLY_BIN=#{FLY_BIN} ruby bin/b21_mcp_e2e_prep.rb", "e2e prep")
  ...
  playwright_ok = system("node bin/b21_mcp_e2e_fly.mjs")
  ...
  mcp_ok = system("ruby bin/b21_mcp_fly_verify.rb")
