...
#   FLY_API_TOKEN=... ruby bin/acceptance/b21_revision_customer_mcp.rb
#
...
Dir.chdir(ROOT) do
  ...
  run!(
    "ruby bin/acceptance/b21_revision_fly_prep.rb",
  ...
  run!("node bin/acceptance/b21_revision_customer_mcp.mjs", "customer MCP screenshots")
  ...
  acceptance["customer_verification"] = {
    ...
    playwright: {
      script: "bin/acceptance/b21_revision_customer_mcp.mjs",
