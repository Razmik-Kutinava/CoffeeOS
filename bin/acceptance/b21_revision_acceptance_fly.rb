...
#
#   ruby bin/acceptance/b21_revision_acceptance_fly.rb
#   FLY_API_TOKEN=... ruby bin/acceptance/b21_revision_acceptance_fly.rb
#
...
Dir.chdir(ROOT) do
  ...
  unless File.exist?(STEPS_TMP)
    run!("ruby bin/acceptance/b21_revision_fly_screenshots.rb", "R4 screenshots")
  end
  ...
  result = {
    ...
    method: "R0–R3 ops gates + Playwright R4 (bin/acceptance/b21_revision_fly_screenshots.rb)",
    ...
    stages: {
      ...
      R3_tests_smoke: {
        ...
        revision_smoke_script: "bin/acceptance/b21_revision_fly_smoke.rb"
      },
      R4_fly_screenshots: {
    ...
    scripts: {
      b21_revision_fly_prep: { path: "bin/acceptance/b21_revision_fly_prep.rb", status: prep ? "PASS" : "MISSING" },
      b21_revision_fly_screenshots_mjs: { path: "bin/acceptance/b21_revision_fly_screenshots.mjs", status: steps_doc["status"] },
      b21_revision_fly_screenshots: { path: "bin/acceptance/b21_revision_fly_screenshots.rb", status: steps_doc["status"] },
      b21_revision_r2_live_fly: { path: "bin/acceptance/b21_revision_r2_live_fly.rb", status: r2&.dig("status") || "MISSING" },
      b21_revision_fly_smoke: { path: "bin/acceptance/b21_revision_fly_smoke.rb", status: smoke&.dig("status") || "NOT_RUN" },
      b21_revision_acceptance_fly: { path: "bin/acceptance/b21_revision_acceptance_fly.rb", status: "PASS" }
    },
    steps: r4_steps,
