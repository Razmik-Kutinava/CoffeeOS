 ...
 *   node bin/acceptance/b21_stage3_guest_screenshots.mjs
 * Требует: tmp/b21_stage3_guest_prep.json (bin/acceptance/b21_stage3_guest_screenshots_prep.rb)
 */
...
async function setBaristaStatus(status) {
  ...
  execSync(`ruby bin/acceptance/b21_stage3_fly_status.rb ${status}`, { stdio: "inherit", cwd: root })
}
