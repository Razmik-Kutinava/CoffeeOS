...
#   FLY_BIN=flyctl ruby bin/acceptance/b21_revision_fly_screenshots.rb

require "json"

root = File.expand_path("../..", __dir__)
prep_script = File.join(root, "bin/acceptance/b21_revision_fly_prep.rb")
mjs_script = File.join(root, "bin/acceptance/b21_revision_fly_screenshots.mjs")
