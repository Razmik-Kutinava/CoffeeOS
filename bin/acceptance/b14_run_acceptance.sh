...
echo "=== 1/4 fly smoke ==="
ruby bin/acceptance/b14_pwa_fly_smoke.rb

echo "=== 2/4 programmatic PWA audit ==="
ruby bin/acceptance/b14_pwa_programmatic_audit.rb

echo "=== 3/4 browser screenshots + LCP ==="
node bin/acceptance/b14_pwa_browser_shots.mjs

echo "=== 4/4 finalize acceptance JSON ==="
ruby bin/acceptance/b14_finalize_acceptance.rb
