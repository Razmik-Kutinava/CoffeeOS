...
# B1.12-R3 — prep Fly: verified email, saved card, cart, JSON для MCP checkout UI.
#
...
OUT = ENV.fetch("OUT", File.join(ROOT, "tmp/b112_r3_one_click_prep.json"))
...
email = "b112-r3-#{suffix}@coffeeos.dev"
name = "B112 R3 QA"
rebill_token = "fly-mcp-r3-rebill-#{suffix}"
masked = "430000******#{suffix[-4..]}"
jar = File.join(Dir.tmpdir, "b112-r3-#{suffix}.cookies")
