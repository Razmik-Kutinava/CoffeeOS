...
#   KIOSK_TOKENS_FILE=/tmp/prog10_kiosk_tokens.json ruby bin/prog10/prog10_kiosk_barista.rb
#   OUT=docs/operations/milestones/veha_2/artifacts/prog10/kiosk/prog10_kiosk_barista.json ruby bin/prog10/prog10_kiosk_barista.rb
...
raise "set KIOSK_TOKENS_FILE (run bin/prog10/prog10_collect_kiosk_tokens.rb first)" if tokens_path.empty? || !File.exist?(tokens_path)
