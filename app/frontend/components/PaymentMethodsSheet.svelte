      ...
      <ul class="pm-sheet__list" role="radiogroup" aria-label="Сохранённые карты">
        {#each cards as card (card.id)}
          <li>
            ...
            >
              <span class="pm-row__brand" aria-hidden="true">{cardBrandShort(card.payment_system)}</span>
              <span class="pm-row__label">{formatCardListLabel(card)}</span>
