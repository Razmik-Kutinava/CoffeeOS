<script>
  ...
  const routes = {
    ...
    "/profile/settings": lazyRoute(() => import("./routes/AccountSettings.svelte")),
    "/about": lazyRoute(() => import("./routes/AboutUs.svelte")),
    "/orders": lazyRoute(() => import("./routes/Orders.svelte")),
    "/order/:id/receipt": lazyRoute(() => import("./routes/OrderReceipt.svelte")),
