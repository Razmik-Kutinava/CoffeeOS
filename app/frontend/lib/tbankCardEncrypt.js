/** B1.12-R2 — RSA-2048 PKCS#1 шифрование CardData (Т-Банк nonPCI). */

import JSEncrypt from "jsencrypt"
import { buildCardDataString } from "./tbankCardFormat.js"
...
export function encryptCardPayload({ pan, expDate, cvv, cardHolder }, publicKeyPem) {
  const plain = buildCardDataString({ pan, expDate, cvv, cardHolder })
