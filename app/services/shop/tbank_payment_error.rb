...
module Shop
  ...
  class TbankPaymentError < OrderCreator::Error
    ...
    FRIENDLY_MESSAGES = {
      ...
      # #46: лимит авторизаций Т-Банка — не ретраить ту же карту.
      "119" => "Слишком много попыток оплаты. Выберите другую карту или подождите",
      "2200" => "Слишком много попыток оплаты. Выберите другую карту или подождите"
    }.freeze
