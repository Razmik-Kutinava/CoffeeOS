...
module Rls
  ...
  # Канон: auth_login · device_token_lookup · shop_api_key_lookup · shop_city_lookup.
  ...
  class GucContext
    ...
    def self.with_shop_city_lookup
      with_local_guc("app.shop_city_lookup", "on") { yield }
    end
    ...
    def self.with_local_guc(key, value)
      ...
      when "app.shop_city_lookup"
        "SET LOCAL app.shop_city_lookup = #{conn.quote(value)}"
      else
