...
3. **Entire (why-context):** на последнем GREEN/docs коммите задачи — `entire checkpoint explain <sha>` (WSL); сверить с `customer_tasks/*.md`, `todo.md`, при интеграции — `docs/integrations/INTEGRATIONS.md` + секция. Зафиксировать в отчёте: учтены ли пункты spec / читал ли агент bridge.
